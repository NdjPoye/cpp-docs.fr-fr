...
### <a name="parameters"></a>Paramètres  
 ...
 il  
 A [std::initializer_list](../standard-library/initializer-list-class.md) de [std::pair](../standard-library/pair-structure.md)objets qui servira à initialiser le map.  
