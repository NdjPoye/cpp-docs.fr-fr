...
L’exemple est tiré d’un extrait de code dans le [Forum sur les applications Windows Store de construction](http://social.msdn.microsoft.com/Forums/winappswithnativecode/thread/211ef583-db11-4e55-926b-6d9ab53dbdb4). L'auteur de cet extrait de code offre les exclusions et les conditions suivantes :
