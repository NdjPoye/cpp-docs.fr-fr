---
title: "Espace de noms de plateforme (C++/CX) | Microsoft Docs"
ms.custom: ""
ms.date: "12/30/2016"
...
|[Platform::FailureException, classe](../cppcx/platform-failureexception-class.md)|Levée lorsque l'opération a échoué. Il s'agit de l'équivalent de E\_FAIL HRESULT.|  
...
## Voir aussi  
 ...
 [Platform::Runtime::CompilerServices \(espace de noms\)](../cppcx/platform-runtime-compilerservices-namespace.md)   
 [Platform::Runtime::InteropServices \(espace de noms\)](../cppcx/platform-runtime-interopservices-namespace.md)   
