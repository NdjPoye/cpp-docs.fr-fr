...
```  
 ...
 Vous pouvez résoudre l’erreur CLS01501 au moyen d’un tableau de paramètres.  Pour plus d’informations, consultez [Variable Argument Lists \(...\) \(C\+\+\/CLI\)](../windows/variable-argument-lists-dot-dot-dot-cpp-cli.md).