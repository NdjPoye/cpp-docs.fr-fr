...
|------------------------------------|---------|------------------------------|  
|\_\_gc struct<br /><br /> ou<br /><br /> \_\_gc class|classe|mot clé [class](../Topic/class%20\(C%23%20Reference\).md)|  
|\_\_value struct<br /><br /> ou<br /><br /> \_\_value class|struct|mot clé [struct](../Topic/struct%20\(C%23%20Reference\).md)|  
