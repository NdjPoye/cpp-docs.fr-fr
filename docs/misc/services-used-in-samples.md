...
Les exemples inclus dans [!INCLUDE[vsipsdk](../mfc/includes/vsipsdk_md.md)] utilisent de nombreux services.  La liste suivante représente plusieurs services utilisées et des exemples qui utilisent.  
...
|<xref:Microsoft.VisualStudio.Shell.Interop.SVsActivityLog>|[Comment : utiliser le journal d’activité](../Topic/How%20to:%20Use%20the%20Activity%20Log.md)|  
...
## Voir aussi  
 [Liste des Services disponibles](../Topic/List%20of%20Available%20Services.md)   
