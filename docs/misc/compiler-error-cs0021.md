...
Impossible d’appliquer l’indexation à l’aide de \[\] à une expression de type 'type'  
 ...
 L’utilisateur a tenté d’accéder à une valeur via un indexeur dans un type de données qui ne prend pas en charge [Indexeurs](../Topic/Indexers%20\(C%23%20Programming%20Guide\).md).  
