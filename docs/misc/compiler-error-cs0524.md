...
'type' : les interfaces ne peuvent pas déclarer de types  
 ...
 Une [interface](../Topic/interface%20\(C%23%20Reference\).md) ne peut pas contenir un type défini par l’utilisateur. Elle doit contenir uniquement des méthodes et des propriétés.  
