...
Un paramètre params doit être le dernier paramètre dans une liste de paramètres formels.  
 ...
 Le paramètre [params](../Topic/params%20\(C%23%20Reference\).md) prend en charge un nombre variable d’arguments et doit se trouver après tous les autres paramètres. Pour plus d'informations, consultez [Méthodes](../Topic/Methods%20\(C%23%20Programming%20Guide\).md).  
