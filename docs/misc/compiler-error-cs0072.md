...
'event' : substitution impossible ; 'method' n’est pas un événement  
 ...
 Un [événement](../Topic/event%20\(C%23%20Reference\).md) peut uniquement se substituer à un autre événement. Pour plus d'informations, consultez [Événements](../Topic/Events%20\(C%23%20Programming%20Guide\).md).  
