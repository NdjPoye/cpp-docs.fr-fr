...
Nom de méthode attendu  
 ...
 Quand vous créez un [délégué](../Topic/delegate%20\(C%23%20Reference\).md), spécifiez une méthode. Pour plus d'informations, consultez [Délégués](../Topic/Delegates%20\(C%23%20Programming%20Guide\).md).  
