...
Le commentaire XML sur 'construction' contient du code XML mal rédigé — 'raison'  
 ...
 Quand vous utilisez [\/doc](../Topic/-doc%20\(C%23%20Compiler%20Options\).md), tous les commentaires du code source doivent être au format XML. Les erreurs de balisage XML génèrent l’avertissement CS1570. Exemple :  
