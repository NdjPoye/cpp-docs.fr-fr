...
Les modificateurs ne peuvent pas être placés sur des déclarations d'accesseurs d'événement  
 ...
 Les modificateurs peuvent être placés uniquement sur des déclarations d’événements, et non sur les déclarations d’accesseurs d’événements. Pour plus d'informations, consultez [Utilisation de propriétés](../Topic/Using%20Properties%20\(C%23%20Programming%20Guide\).md).  
