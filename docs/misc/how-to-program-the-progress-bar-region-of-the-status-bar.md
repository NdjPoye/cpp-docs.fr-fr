...
La zone de barre de progression de la barre d'état de [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)] affiche la progression incrémentielle des opérations rapides, par exemple, l'enregistrement d'un fichier sur le disque.  
