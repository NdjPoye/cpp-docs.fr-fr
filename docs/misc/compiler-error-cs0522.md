...
'constructeur' : les structures ne peuvent pas appeler les constructeurs de classe de base  
 ...
 Un [struct](../Topic/struct%20\(C%23%20Reference\).md) ne peut pas appeler un constructeur de classe de base. Supprimez l’appel au constructeur de classe de base.  
