...
-   [Le commentaire XML ne peut pas être appliqué plusieurs fois sur un \<type\> partiel](../misc/xml-comment-cannot-be-applied-more-than-once-on-a-partial-type.md).  
...
-   [Erreur d’analyse de la documentation XML : la balise de début '\<balise\>' n’a pas de balise de fin correspondante](../misc/xml-documentation-parse-error-start-tag-tag-doesn-t-have-a-matching-end-tag.md).  
