 ...
 **Extension de fichier**  
 Définissez l’extension de nom de fichier associée à votre éditeur. Vous pouvez spécifier plusieurs extensions en tapant une liste délimitée par des virgules. Votre éditeur est l’éditeur [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)] par défaut pour les fichiers ayant l’extension de nom de fichier que vous définissez.  
