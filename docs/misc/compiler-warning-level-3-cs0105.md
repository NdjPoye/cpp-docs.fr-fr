...
La directive using de 'namespace' est apparue précédemment dans cet espace de noms  
 ...
 Un [espace de noms](../Topic/namespace%20\(C%23%20Reference\).md), qui ne doit être déclaré qu’une fois, a été déclaré plusieurs fois ; supprimez toutes les déclarations d’espace de noms en double.  
