...
L’outil ALink, appelé par le compilateur [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)], signale une erreur lors de la génération de l’assembly. Il est possible qu’un assembly signé fasse référence à un assembly non signé.  
