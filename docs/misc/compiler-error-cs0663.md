...
Impossible de définir des méthodes surchargées qui se différencient uniquement au niveau des paramètres ref et out  
 ...
 Les méthodes qui diffèrent uniquement par leur utilisation de [ref](../Topic/ref%20\(C%23%20Reference\).md) et de [out](../Topic/out%20\(C%23%20Reference\).md) sur un paramètre ne sont pas autorisées.  
