...
Une [Operator Statement](../Topic/Operator%20Statement.md) spécifie à la fois [Widening](../Topic/Widening%20\(Visual%20Basic\).md) et [Narrowing](../Topic/Narrowing%20\(Visual%20Basic\).md).  
