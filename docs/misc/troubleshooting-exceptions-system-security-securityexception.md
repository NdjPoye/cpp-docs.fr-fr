...
## Conseils associés  
 ...
 Une API équivalente peut exister dans le .NET Framework. Pour plus d'informations, consultez [Troubleshooting Interoperability](../Topic/Troubleshooting%20Interoperability%20\(Visual%20Basic\).md).  
 ...
 Pour plus d'informations, consultez [Considérations spécifiques sur la sécurité pour les solutions Office](../Topic/Specific%20Security%20Considerations%20for%20Office%20Solutions.md).  
