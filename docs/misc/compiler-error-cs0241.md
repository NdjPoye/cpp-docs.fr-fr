...
Les spécificateurs de paramètres par défaut ne sont pas autorisés  
 ...
 Les [paramètres de méthode](../Topic/Method%20Parameters%20\(C%23%20Reference\).md) ne peuvent pas avoir de valeurs par défaut. Utilisez des surcharges de méthode pour obtenir le même effet. Pour plus d'informations, consultez [Passage de paramètres](../Topic/Passing%20Parameters%20\(C%23%20Programming%20Guide\).md).  
