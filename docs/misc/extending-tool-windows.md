...
## Éléments de base des fenêtres Outil  
 Pour fournir une fenêtre Outil, vous devez l’inscrire auprès de Visual Studio et spécifier sa taille et son emplacement par défaut. Pour plus d’informations, consultez [Fenêtres Outil dans le Registre](../Topic/Tool%20Windows%20in%20the%20Registry.md).  
...
## Voir aussi  
 ...
 [Fenêtres de document](../Topic/Document%20Windows.md)   
 [Ajout de la recherche dans une fenêtre outil](../Topic/Adding%20Search%20to%20a%20Tool%20Window.md)