...
---
# exponential_distribution::lambda
Retourne le paramètre de distribution lambda.  
...
## Notes  
 La fonction membre retourne la valeur stockée `lambda`.  
...
## Voir aussi  
 ...
 [exponential\_distribution, classe](../standard-library/exponential-distribution-class.md)