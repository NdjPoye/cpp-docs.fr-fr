...
Les déclarations partielles de 'type' ne doivent pas spécifier des classes de base différentes  
 ...
 Quand vous définissez un type dans des déclarations partielles, spécifiez les mêmes types de base dans chacune des déclarations partielles. Pour plus d'informations, consultez [Classes et méthodes partielles](../Topic/Partial%20Classes%20and%20Methods%20\(C%23%20Programming%20Guide\).md).  
