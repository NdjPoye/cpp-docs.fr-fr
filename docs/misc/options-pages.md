...
## Dans cette section  
 ...
 Explique comment un VSPackage peut utiliser le modèle Automation de [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)] pour gérer l’état des pages **Outils\/Options**.  
