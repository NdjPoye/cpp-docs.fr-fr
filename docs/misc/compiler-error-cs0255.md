...
stackalloc ne peut être utilisé dans un bloc catch ou finally  
 ...
 Vous ne pouvez pas utiliser le mot clé [stackalloc](../Topic/stackalloc%20\(C%23%20Reference\).md) dans un bloc [catch](../Topic/try-catch%20\(C%23%20Reference\).md) ou [finally](../Topic/try-catch-finally%20\(C%23%20Reference\).md). Pour plus d'informations, consultez [Exceptions et gestion des exceptions](../Topic/Exceptions%20and%20Exception%20Handling%20\(C%23%20Programming%20Guide\).md).  
