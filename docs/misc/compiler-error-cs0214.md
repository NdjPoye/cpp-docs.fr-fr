...
Les pointeurs et les mémoires tampons de taille fixe ne peuvent être utilisés que dans un contexte unsafe  
 ...
 Les pointeurs ne peuvent être utilisés qu’avec le mot clé [unsafe](../Topic/unsafe%20\(C%23%20Reference\).md). Pour plus d'informations, consultez [Pointeurs et code unsafe](../Topic/Unsafe%20Code%20and%20Pointers%20\(C%23%20Programming%20Guide\).md).  
