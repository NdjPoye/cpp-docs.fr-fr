...
2.  Utilisez le mot clé [Nothing](../Topic/Nothing%20\(Visual%20Basic\).md) pour les assignations et les comparaisons quand vous utilisez des variables d’objet. Cela est illustré par l'exemple suivant.  
