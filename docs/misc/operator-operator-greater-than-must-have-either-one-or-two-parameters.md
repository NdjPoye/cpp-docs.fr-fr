...
-   Si vous n’avez pas besoin de paramètre ou en nécessitez plus de deux, vous devez utiliser [Function Statement](../Topic/Function%20Statement%20\(Visual%20Basic\).md) pour définir une procédure `Function` au lieu d’un opérateur.  
