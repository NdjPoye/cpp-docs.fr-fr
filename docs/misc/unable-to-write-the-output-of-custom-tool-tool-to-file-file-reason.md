...
-   Redémarrez [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)] et réexécutez l'outil personnalisé en cliquant avec le bouton droit sur le fichier affecté et en sélectionnant **Exécuter un outil personnalisé** dans le menu contextuel.  
