...
Le compilateur [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)] ne peut pas interpréter l’un de ses fichiers écrits en interne.  
...
2.  Si l'erreur se produit à nouveau, réinstallez le compilateur [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)].  
