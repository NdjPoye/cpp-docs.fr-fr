...
La partie gauche d'une assignation doit être une variable, une propriété ou un indexeur  
 ...
 Pour corriger cette erreur, vérifiez que tous les opérateurs sont dans la partie droite et que la partie gauche correspond à une variable, une propriété ou un indexeur. Pour plus d’informations, consultez [Instructions, expressions et opérateurs](../Topic/Statements,%20Expressions,%20and%20Operators%20\(C%23%20Programming%20Guide\).md).  
