...
Un pointeur ne doit être indexé que par une seule valeur  
 ...
 Un pointeur ne peut pas avoir plusieurs index. Pour plus d'informations, consultez [Types pointeur](../Topic/Pointer%20types%20\(C%23%20Programming%20Guide\).md)  
