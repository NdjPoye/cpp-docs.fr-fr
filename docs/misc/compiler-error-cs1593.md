...
Le délégué 'del' ne prend pas les arguments 'nombre'  
 ...
 Le nombre d’arguments passés à un appel de [délégué](../Topic/delegate%20\(C%23%20Reference\).md) ne correspond pas au nombre de paramètres dans la déclaration du délégué.  
