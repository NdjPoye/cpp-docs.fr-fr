...
N’utilisez pas 'System.ParamArrayAttribute'. Utilisez plutôt le mot clé 'params'.  
 ...
 Le compilateur C\# n’autorise pas l’utilisation de <xref:System.ParamArrayAttribute?displayProperty=fullName> ; utilisez [params](../Topic/params%20\(C%23%20Reference\).md) à la place.  
