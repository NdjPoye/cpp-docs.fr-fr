...
L’interface héritée 'interface1' provoque un cycle dans la hiérarchie des interfaces de 'interface2'  
 ...
 La liste d’héritage pour une [interface](../Topic/interface%20\(C%23%20Reference\).md) comprend une référence directe ou indirecte à elle\-même. Une interface ne peut pas hériter d’elle\-même.  
