...
Identificateur attendu ; 'keyword' est un mot clé  
 ...
 Un mot réservé pour le langage C\# a été trouvé alors qu’un identificateur était attendu. Remplacez le [mot\-clé](../Topic/C%23%20Keywords.md) par un identificateur spécifié par l’utilisateur.  
