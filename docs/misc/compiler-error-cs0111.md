...
Le type 'class' définit déjà un membre appelé 'member' avec les mêmes types de paramètres  
 ...
 L’erreur CS0111 se produit si une classe contient deux déclarations membres avec le même nom et les mêmes types de paramètres. Pour plus d'informations, consultez [Méthodes](../Topic/Methods%20\(C%23%20Programming%20Guide\).md).  
