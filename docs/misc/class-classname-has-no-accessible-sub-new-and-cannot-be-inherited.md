...
Une classe utilise une instruction Inherits \([Inherits Statement](../Topic/Inherits%20Statement.md)\) pour spécifier une classe de base, mais elle ne peut accéder à aucun constructeur sur la classe de base prévue.  
