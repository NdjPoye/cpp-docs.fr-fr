...
> [!NOTE]
>  Une grande partie de l'exemple de code non managé dans la section d'intégration Visual Studio de [!INCLUDE[vsipsdk](../mfc/includes/vsipsdk_md.md)] utilise ATL \(ATL\).  Vous n'avez pas besoin d'utiliser ATL pour créer les VSPackages, mais vous devez comprendre ATL pour inclure l'exemple de code.  
