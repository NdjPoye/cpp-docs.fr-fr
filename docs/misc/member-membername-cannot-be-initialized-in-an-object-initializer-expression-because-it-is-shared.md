...
Vous ne pouvez pas utiliser des initialiseurs d’objets pour initialiser un membre d’une classe déclaré comme étant partagé. Pour plus d'informations, consultez [Shared](../Topic/Shared%20\(Visual%20Basic\).md).  
