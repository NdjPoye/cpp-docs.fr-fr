...
Le membre 'membre1' se substitue au membre obsolète 'membre2'. Ajoutez l’attribut Obsolete à 'membre1'  
 ...
 Le compilateur a trouvé un `override` à une méthode marquée comme `obsolete`. Toutefois, la méthode de substitution n’était pas marquée comme obsolète. La méthode de substitution va générer l’erreur [CS0612](../misc/compiler-warning-level-1-cs0612.md) si elle est appelée.  
