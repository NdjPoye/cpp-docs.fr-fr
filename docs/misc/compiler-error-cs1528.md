...
; ou \= attendu \(impossible de spécifier des arguments de constructeur dans une déclaration\)  
 ...
 Une référence à une classe a été spécifiée comme si un objet de la classe était créé. Par exemple, une tentative de passer une variable à un constructeur a eu lieu. Utilisez l’opérateur [new](../Topic/new%20\(C%23%20Reference\).md) pour créer un objet d’une classe.  
