...
Vous avez fourni un nom qui est ambigu et donc en conflit avec un autre nom. Le compilateur [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)] n’a pas de règles de résolution de conflit. Vous devez lever vous\-même toute ambiguïté sur les noms.  
