...
Le niveau d'avertissement doit être compris entre 0 et 4  
 ...
 L’option du compilateur [\/warn](../Topic/-warn%20\(C%23%20Compiler%20Options\).md) peut uniquement prendre l’une des cinq valeurs possibles \(0, 1, 2, 3 ou 4\). Toute autre valeur passée à **\/warn** génère l’erreur CS1900.  
