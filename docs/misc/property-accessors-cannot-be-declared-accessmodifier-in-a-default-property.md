...
Une [Get Statement](../Topic/Get%20Statement.md) ou une [Set Statement](../Topic/Set%20Statement%20\(Visual%20Basic\).md) dans une propriété par défaut inclut le mot clé `Private`.  
...
-   Supprimez le mot clé `Private` de l’instruction `Get` ou `Set`, ou supprimez `Default` de l’[Property Statement](../Topic/Property%20Statement.md).  
