...
L'utilisation du mot clé 'base' n'est pas valide dans ce contexte  
 ...
 Le mot clé [de base](../Topic/base%20\(C%23%20Reference\).md) doit être utilisé pour spécifier un membre spécifique de la classe de base. Pour plus d'informations, consultez [Constructeurs](../Topic/Constructors%20\(C%23%20Programming%20Guide\).md).  
