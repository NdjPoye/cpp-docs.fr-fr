...
La propriété ou l’indexeur 'property\/indexer' ne peut pas être utilisé dans ce contexte, car l’accesseur get n’est pas accessible  
 ...
 Cette erreur se produit quand vous essayez d’accéder à un accesseur `get` inaccessible. Pour résoudre cette erreur, augmentez l’accessibilité de l’accesseur ou modifiez l’emplacement d’appel. Pour plus d’informations, consultez [Accessibilité de l’accesseur](../Topic/Restricting%20Accessor%20Accessibility%20\(C%23%20Programming%20Guide\).md) et [Propriétés](../Topic/Properties%20\(C%23%20Programming%20Guide\).md).  
