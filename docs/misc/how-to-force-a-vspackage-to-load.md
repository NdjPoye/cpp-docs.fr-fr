...
## Programmation fiable  
 Le chargement de force ne doit pas être utilisé pour la communication d'un VSPackage.  Utilisez plutôt [À l'aide et fournir des Services](../Topic/Using%20and%20Providing%20Services.md).  
