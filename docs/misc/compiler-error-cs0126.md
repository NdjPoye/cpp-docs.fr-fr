...
Un objet d’un type convertible en 'type' est requis  
 ...
 Une instruction return est présente, mais elle ne retourne pas une valeur du type attendu. Pour plus d'informations, consultez [Propriétés](../Topic/Properties%20\(C%23%20Programming%20Guide\).md).  
