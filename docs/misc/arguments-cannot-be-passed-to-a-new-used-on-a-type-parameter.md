...
Une déclaration ou une instruction d’assignation appelle un type générique et fournit des arguments de constructeur à un paramètre de type qui possède la contrainte [New Operator](../Topic/New%20Operator%20\(Visual%20Basic\).md).  
