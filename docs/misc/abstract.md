...
## Notes  
 ...
 Différente de la notion C\+\+ de classe de base [abstraite](../cpp/abstract-classes-cpp.md), une classe avec le mot clé `__abstract` peut définir ses fonctions membres.  
