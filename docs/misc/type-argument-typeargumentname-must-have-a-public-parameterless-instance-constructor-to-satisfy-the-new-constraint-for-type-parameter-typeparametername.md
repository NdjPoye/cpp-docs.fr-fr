...
Un argument de type fournit un type sans un constructeur sans paramètre accessible à un paramètre de type avec la contrainte [New Operator](../Topic/New%20Operator%20\(Visual%20Basic\).md).  
