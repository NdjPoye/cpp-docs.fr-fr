...
'event' : l’événement dans l’interface ne peut pas avoir d’initialiseur  
 ...
 Un événement dans une interface ne peut pas avoir d’initialiseur. Pour plus d'informations, consultez [Interfaces](../Topic/Interfaces%20\(C%23%20Programming%20Guide\).md).  
