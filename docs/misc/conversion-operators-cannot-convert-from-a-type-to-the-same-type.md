...
-   Si vous avez besoin de transformer le contenu du paramètre, utilisez une [Function Statement](../Topic/Function%20Statement%20\(Visual%20Basic\).md) pour définir une procédure `Function` au lieu d’un opérateur.  
