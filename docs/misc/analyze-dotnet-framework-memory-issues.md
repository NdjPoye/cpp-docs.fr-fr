...
##  <a name="BKMK_Memory_use_in__NET_Framework_apps"></a> Utilisation de la mémoire dans les applications .NET Framework  
 ...
 ![Retour au début](../misc/media/pcs_backtotop.png "PCS\_BackToTop") [Contenu](#BKMK_Contents)  
...
1.  Vous pouvez créer un fichier dump pour un processus qui a été démarré à partir d'un projet Visual Studio ou vous pouvez attacher le débogueur à un processus en cours d'exécution.  Consultez [Attacher aux processus en cours d'exécution](../Topic/Attach%20to%20Running%20Processes%20with%20the%20Visual%20Studio%20Debugger.md).  
