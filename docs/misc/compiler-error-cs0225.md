...
Le paramètre params doit être un tableau à une seule dimension  
 ...
 Quand vous utilisez le mot clé [params](../Topic/params%20\(C%23%20Reference\).md), vous devez spécifier un tableau unidimensionnel du type de données. Pour plus d’informations, consultez [Méthodes](../Topic/Methods%20\(C%23%20Programming%20Guide\).md).  
