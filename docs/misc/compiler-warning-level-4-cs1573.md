...
Le paramètre 'parameter' n’a pas de balise param correspondante dans le commentaire XML pour 'parameter' \(contrairement à d’autres paramètres\)  
 ...
 Lors de l’utilisation de l’option [\/doc](../Topic/-doc%20\(C%23%20Compiler%20Options\).md) du compilateur, un commentaire a été spécifié pour certains, mais pas pour tous les paramètres d’une méthode. Vous avez peut\-être oublié d’entrer un commentaire pour ces paramètres.  
