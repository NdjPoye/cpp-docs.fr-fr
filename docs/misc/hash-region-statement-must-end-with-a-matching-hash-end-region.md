...
Utilisez la directive `#Region` pour spécifier un bloc de code que vous pouvez développer ou réduire en mode Plan de l’éditeur de code [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)]. Le début et la fin des instructions `#Region` doivent se trouver dans le même bloc de code.  
