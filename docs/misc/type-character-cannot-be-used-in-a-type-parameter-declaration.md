...
Une déclaration de paramètre de type contient au moins un caractère de type identificateur.  
 ...
 Un paramètre de type d’un type générique doit être un nom Visual Basic valide. Les caractères de type identificateur \(`%`, `&`, `@`, `!`, `#` et `$`\) ne figurent pas parmi les caractères autorisés. Consultez [Declared Element Names](../Topic/Declared%20Element%20Names%20\(Visual%20Basic\).md).  
