...
Les structures ne peuvent pas contenir de constructeurs exempts de paramètres explicites  
 ...
 Chaque [struct](../Topic/struct%20\(C%23%20Reference\).md) a déjà un constructeur par défaut qui initialise l’objet à zéro. Les constructeurs que vous pouvez créer pour un struct doivent donc accepter un ou plusieurs paramètres.  
