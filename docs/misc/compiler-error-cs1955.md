...
## Exemple  
 Le code suivant génère l’erreur CS1955 car le code essaie d’appeler un champ et une propriété à l’aide de l’opérateur d’appel de méthode [\(\)](../Topic/\(\)%20Operator%20\(C%23%20Reference\).md). Vous ne pouvez pas appeler un champ ou une propriété, mais vous pouvez accéder à la valeur qu’il ou elle stocke à l’aide de l’opérateur d’accès au membre \([.](../Topic/.%20Operator%20\(C%23%20Reference\).md)\).  
