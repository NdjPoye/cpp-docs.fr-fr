...
-   Un lien existe déjà. La limitation suivante s’applique au système de projet [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)] et [!INCLUDE[csprcs](../ide/includes/csprcs_md.md)] : il ne peut pas y avoir plusieurs liens portant le même nom dans le même projet. Cela signifie, par exemple, que vous ne pouvez pas spécifier un lien au fichier .vb à la fois dans le dossier A et le dossier B du projet.  
