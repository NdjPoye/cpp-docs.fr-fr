...
Directive de préprocesseur attendue  
 ...
 Une ligne commence par le symbole dièse \(\#\), mais la chaîne suivante n’est pas une [directive de préprocesseur](../Topic/C%23%20Preprocessor%20Directives.md) valide.  
