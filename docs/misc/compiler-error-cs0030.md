...
Impossible de convertir le type 'type' en 'type'  
 ...
 Vous devez fournir des routines de conversion pour prendre en charge certaines surcharges d’opérateur. Pour plus d’informations, consultez [Conversion, opérateurs](../Topic/Conversion%20Operators%20\(C%23%20Programming%20Guide\).md).  
