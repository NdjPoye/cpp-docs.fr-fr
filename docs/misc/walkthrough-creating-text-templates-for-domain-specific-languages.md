...
Cette rubrique a été consolidé avec un autre contenu.    accédez à [Génération de code à partir d'un langage spécifique à un domaine](../Topic/Generating%20Code%20from%20a%20Domain-Specific%20Language.md).