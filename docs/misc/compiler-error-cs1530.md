...
Le mot clé 'new' n'est pas autorisé dans les éléments définis dans un espace de noms  
 ...
 Il n’est pas utile de spécifier le mot clé [new](../Topic/new%20\(C%23%20Reference\).md) sur une construction qui se trouve dans un [espace de noms](../Topic/namespace%20\(C%23%20Reference\).md).  
