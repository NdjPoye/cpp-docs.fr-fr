...
Impossible de créer un tableau avec une taille négative  
 ...
 Une taille de tableau a été spécifiée avec un nombre négatif. Pour plus d'informations, consultez [Tableaux](../Topic/Arrays%20\(C%23%20Programming%20Guide\).md).  
