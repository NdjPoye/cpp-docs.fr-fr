...
'declaration' : la déclaration d’interface explicite ne peut être déclarée que dans une classe ou une structure  
 ...
 Une déclaration d’[interface](../Topic/interface%20\(C%23%20Reference\).md) explicite a été trouvée en dehors d’une [classe](../Topic/class%20\(C%23%20Reference\).md) ou d’une [structure](../Topic/struct%20\(C%23%20Reference\).md).  
