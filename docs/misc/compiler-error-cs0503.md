...
La méthode 'méthode' de type abstract ne peut pas être marquée virtual  
 ...
 Il est superflu de marquer une méthode membre à la fois comme [abstract](../Topic/abstract%20\(C%23%20Reference\).md) et [virtual](../Topic/virtual%20\(C%23%20Reference\).md), car **abstract** implique **virtual**.  
