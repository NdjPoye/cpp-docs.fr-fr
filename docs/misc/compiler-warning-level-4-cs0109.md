...
Le membre 'membre' ne masque pas un membre hérité. Le mot clé new n’est pas requis  
 ...
 Une déclaration de classe comprend le mot clé [new](../Topic/new%20\(C%23%20Reference\).md) alors qu’elle ne remplace pas une déclaration existante dans une classe de base. Vous pouvez supprimer le mot clé **new**.  
