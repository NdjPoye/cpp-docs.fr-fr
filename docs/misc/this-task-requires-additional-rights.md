...
Cette erreur s'affiche si une commande Visual Studio est appelée par un utilisateur dont le compte a des autorisations insuffisantes pour effectuer l'opération.  
 ...
 Pour plus d'informations sur les autorisations en exécutant Visual Studio, consultez l' [Autorisations utilisateur](../Topic/User%20Permissions%20and%20Visual%20Studio.md).  
