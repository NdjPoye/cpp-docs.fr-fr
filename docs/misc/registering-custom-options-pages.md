...
### Enregistrez une page d'options Outils comme automation de prise en charge  
 ...
 L'entrée du Registre est trouvée dans \\SOFTWARE\\Microsoft\\VisualStudio HKEY\_LOCAL\_MACHINE \\*\<version\>*\\AutomationProperties, où *\<version\>* est la version d' [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)], par exemple 8,0.  
  
> [!NOTE]
>  Le chemin d'accès racine HKEY\_LOCAL\_MACHINE \\SOFTWARE\\Microsoft\\VisualStudio \\*\<version\>* peut être substitué par une autre racine lorsque le shell Visual Studio est initialisé, car plus d'informations, consultez [Commutateurs de ligne de commande](../Topic/Command-Line%20Switches%20\(Visual%20Studio%20SDK\).md).  
