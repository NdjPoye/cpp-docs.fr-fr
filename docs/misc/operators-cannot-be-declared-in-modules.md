...
Une [Operator Statement](../Topic/Operator%20Statement.md) s’affiche dans une définition de module.  
...
-   Si vous avez besoin d’une opération sur le module, utilisez une [Function Statement](../Topic/Function%20Statement%20\(Visual%20Basic\).md) pour définir une procédure `Function` qui effectue l’opération.  
