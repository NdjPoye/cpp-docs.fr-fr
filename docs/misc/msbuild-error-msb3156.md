...
**MSB3156 : La validation XML n'a pas réussi pour l'élément '\<package\>' situé dans '\<dossier\>'.**  
 ...
 Cet avertissement est généré lorsque le manifeste \(product.xml\) ne réussit pas la validation XML.  Les problèmes spécifiques sont répertoriés dans un message d'erreur ultérieur \([MSBuild Error MSB3159](../misc/msbuild-error-msb3159.md) ou [MSBuild Error MSB3160](../misc/msbuild-error-msb3160.md)\).  
