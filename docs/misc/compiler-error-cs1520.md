...
La méthode doit avoir un type de retour  
 ...
 Une méthode qui est déclarée dans une classe, une structure ou une interface doit avoir un type de retour explicite. Dans l’exemple suivant, la méthode Square a la valeur de retour [string](../Topic/string%20\(C%23%20Reference\).md) :  
...
## Voir aussi  
 [Méthodes](../Topic/Methods%20\(C%23%20Programming%20Guide\).md)   
 [Constructeurs](../Topic/Constructors%20\(C%23%20Programming%20Guide\).md)