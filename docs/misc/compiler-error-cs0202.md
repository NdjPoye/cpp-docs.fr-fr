...
> [!NOTE]
>  En C\# 2.0, le compilateur génère automatiquement Current et MoveNext pour vous. Pour plus d’informations, consultez l’exemple de code dans [Interfaces génériques](../Topic/Generic%20Interfaces%20\(C%23%20Programming%20Guide\).md).  
