...
-   Si les contraintes de paramètre de type doivent rester telles que vous les avez définies, vous ne pouvez pas implémenter le membre d’interface dans cette déclaration. Supprimez le mot clé [Implements](../Topic/Implements%20Clause%20\(Visual%20Basic\).md) de la déclaration.  
