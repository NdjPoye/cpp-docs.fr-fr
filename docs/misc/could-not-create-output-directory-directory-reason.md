 ...
 *DossierProjet*\\obj\\`configname`\\temppe  
 ...
 outputdir  
 Répertoire spécifié par la propriété de chemin de sortie.  Pour plus d'informations, consultez [Générer, page du Concepteur de projets \(C\#\)](../Topic/Build%20Page,%20Project%20Designer%20\(C%23\).md).  
