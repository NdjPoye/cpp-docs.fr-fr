...
L’expression de compilation conditionnelle fait référence à un type non intrinsèque, mais seuls les types intrinsèques sont autorisés.  
 ...
 Pour plus d’informations sur le type intrinsèque dans [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)], consultez [Data Types Summary](../Topic/Data%20Types%20Summary%20\(Visual%20Basic\).md).  
