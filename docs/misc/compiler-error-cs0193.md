...
L'opérateur \* ou \-\> doit être appliqué à un pointeur  
 ...
 L’opérateur **\*** ou **\-\>** a été utilisé avec un type non pointeur. Pour plus d'informations, consultez [Types pointeur](../Topic/Pointer%20types%20\(C%23%20Programming%20Guide\).md).  
