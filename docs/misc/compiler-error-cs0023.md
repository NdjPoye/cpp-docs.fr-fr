...
Impossible d’appliquer l’opérateur 'opérateur' à un opérande de type 'type'  
 ...
 L’utilisateur a tenté d’appliquer un opérateur à une variable dont le type n’est pas compatible avec l’opérateur. Pour plus d’informations, consultez [Types](../Topic/Types%20\(C%23%20Programming%20Guide\).md) et [Opérateurs C\#](../Topic/C%23%20Operators.md).  
