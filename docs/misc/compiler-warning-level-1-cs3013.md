...
Les modules ajoutés doivent être marqués avec l'attribut CLSCompliant pour correspondre à l'assembly  
 ...
 Un module compilé avec l’option de compilateur [\/target:module](../Topic/-target:module%20\(C%23%20Compiler%20Options\).md) a été ajoutée à une compilation avec [\/addmodule](../Topic/-addmodule%20\(C%23%20Compiler%20Options\).md). Toutefois, la conformité du module à la spécification CLS \(Common Language Specification\) ne correspond pas à l’état CLS de la compilation en cours.  
