...
Par défaut, lorsque vous générez des VSPackages, ils sont inscrits dans la ruche de Registre expérimentale. Votre ruche expérimentale peut se remplir de VSPackages que vous ne souhaitez pas conserver une fois que vous en avez fini avec eux.  
 ...
 Pour supprimer tous les packages qui sont inscrits dans la ruche expérimentale, il suffit de réinitialiser la ruche en exécutant l’outil CreateExpInstance avec l’option \/Reset. Pour plus d'informations, consultez [L'Instance expérimentale](../Topic/The%20Experimental%20Instance.md).  
