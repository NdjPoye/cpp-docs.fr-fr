...
Le paramètres params ne peut pas être déclaré comme ref ou out  
 ...
 Vous ne pouvez pas utiliser les mots clés [ref](../Topic/ref%20\(C%23%20Reference\).md) ou [out](../Topic/out%20\(C%23%20Reference\).md) avec le mot clé [params](../Topic/params%20\(C%23%20Reference\).md).  
