...
[Event Statement](../Topic/Event%20Statement.md) utilise un délégué pour spécifier sa signature, mais [Delegate Statement](../Topic/Delegate%20Statement.md) est marqué comme étant `<CLSCompliant(False)>` ou n’est pas marqué.  
