...
## Notes  
 L'opérateur **\_\_typeof** vous permet d'obtenir le type **System::Type** d'un type que vous spécifiez.**\_\_typeof** peut également servir à retourner une valeur **System::Type** dans un bloc d'attributs personnalisé. Pour plus d'informations sur la création de vos propres attributs, consultez [attribute](../windows/attribute.md).  
