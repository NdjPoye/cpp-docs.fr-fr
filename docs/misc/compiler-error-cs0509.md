...
'classe1' : dérivation du type sealed 'classe2' impossible  
 ...
 Une classe [sealed](../Topic/sealed%20\(C%23%20Reference\).md) ne peut pas être utilisée comme une classe de [base](../Topic/base%20\(C%23%20Reference\).md). Par défaut, les structures sont sealed.  
