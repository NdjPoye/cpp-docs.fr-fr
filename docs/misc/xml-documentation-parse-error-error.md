...
-   [La balise de commentaire XML '\<balise\>' n’est pas autorisée dans un élément de langage '\<élément\>'](../misc/xml-comment-tag-tag-is-not-permitted-on-a-element-language-element.md)  
