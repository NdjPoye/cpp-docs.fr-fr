...
L’étiquette 'étiquette' figure déjà dans cette instruction switch  
 ...
 Une étiquette a été répétée dans une instruction [switch](../Topic/switch%20\(C%23%20Reference\).md). Pour plus d'informations, consultez [switch](../Topic/switch%20\(C%23%20Reference\).md).  
