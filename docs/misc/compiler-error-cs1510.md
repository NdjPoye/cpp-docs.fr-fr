...
Un argument ref ou out doit être une variable qui peut être assignée  
 ...
 Seule une variable peut être passée comme un paramètre [ref](../Topic/ref%20\(C%23%20Reference\).md) dans un appel de méthode. Une valeur `ref` correspond au passage d’un pointeur.  
