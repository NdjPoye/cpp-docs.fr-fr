...
'membre\_classe\_dérivée' masque le membre abstrait hérité 'membre\_classe\_de\_base'  
 ...
 Une méthode de [classe](../Topic/class%20\(C%23%20Reference\).md) de base est masquée. Vérifiez si la syntaxe de votre déclaration est correcte.  
  
 Pour plus d'informations, consultez [base](../Topic/base%20\(C%23%20Reference\).md).  
