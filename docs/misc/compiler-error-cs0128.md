...
Une variable locale nommée 'variable' est déjà définie dans cette portée  
 ...
 Le compilateur a détecté des déclarations de deux variables locales portant le même nom. Pour plus d'informations, consultez [Méthodes](../Topic/Methods%20\(C%23%20Programming%20Guide\).md).  
