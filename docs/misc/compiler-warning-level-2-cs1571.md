...
Le commentaire XML sur 'construction' a une balise param en double pour 'paramètre'  
 ...
 Lors de l’utilisation de l’option du compilateur [\/doc](../Topic/-doc%20\(C%23%20Compiler%20Options\).md), plusieurs commentaires ont été détectés pour le même paramètre de méthode. Supprimez l’une des lignes dupliquées.  
