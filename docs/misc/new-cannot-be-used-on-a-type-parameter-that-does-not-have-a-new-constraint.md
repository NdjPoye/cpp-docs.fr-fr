...
Une instruction de déclaration utilise une clause [New Operator](../Topic/New%20Operator%20\(Visual%20Basic\).md) qui spécifie un paramètre de type comme le type à créer, et le paramètre de type est déclaré sans contrainte `New`.  
