...
Une référence au module '\<nom\_module\>' contenant la classe de base '\<nom\_classe\>' est requise. Ajoutez\-en une à votre projet.  
 ...
 La classe est définie dans un module qui n’est pas directement référencé dans votre projet. Le compilateur [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)] nécessite une référence pour éviter toute ambiguïté au cas où la classe serait définie dans plusieurs modules.  
