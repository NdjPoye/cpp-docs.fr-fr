...
> [!NOTE]
>  La bibliothèque de Visual Studio s'appuie sur l'ATL \(ATL\) pour sa prise en charge des objets COM.  Pour plus d'informations, consultez [Introduction to ATL](../atl/introduction-to-atl.md).  
