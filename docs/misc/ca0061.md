...
## Propriété CodeAnalysisRules de MSBuild  
 Dans l'analyse du code de [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)], des règles peuvent être spécifiées à l'aide de la propriété de CodeAnalysisRules de MSBuild au format suivant :  
