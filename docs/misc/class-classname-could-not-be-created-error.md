...
Une initialisation de classe a échoué. L’une des causes possibles est une installation [!INCLUDE[dnprdnshort](../error-messages/tool-errors/includes/dnprdnshort_md.md)] endommagée.  
...
2.  Réinstallez le [!INCLUDE[dnprdnshort](../error-messages/tool-errors/includes/dnprdnshort_md.md)] et recompilez le programme.  
