...
## Dans cette section  
 [Modèle Automation](../misc/automation-model.md)  
...
## Rubriques connexes  
 ...
 Traite de l'automatisation, les VSPackages, ou une combinaison pour créer des applications d'extensibilité de [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)] .