...
Le délégué 'délégué' ne possède pas de constructeur valide  
 ...
 Vous avez importé et utilisé un programme managé \(qui utilise le common language runtime .NET Framework\) créé avec un autre compilateur. Ce compilateur a autorisé un constructeur [délégué](../Topic/delegate%20\(C%23%20Reference\).md) incorrect. Pour plus d'informations, consultez [Délégués](../Topic/Delegates%20\(C%23%20Programming%20Guide\).md).