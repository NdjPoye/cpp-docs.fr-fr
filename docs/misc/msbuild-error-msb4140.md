...
**MSB4140: pas de ToolsVersion  par défaut spécifié dans le Registre ni dans le fichier de configuration.**  
 ...
 Le projet ne spécifie pas de valeur `ToolsVersion` par défaut.  Par conséquent, [!INCLUDE[vstecmsbuild](../build/includes/vstecmsbuild_md.md)] n'est pas en mesure de déterminer la valeur à utiliser.  
