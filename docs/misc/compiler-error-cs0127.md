...
Comme 'fonction' retourne void, un mot clé return ne peut pas être suivi d’une expression d’objet  
 ...
 Une méthode avec un type de retour [void](../Topic/void%20\(C%23%20Reference\).md) ne peut pas retourner de valeur. Pour plus d'informations, consultez [Méthodes](../Topic/Methods%20\(C%23%20Programming%20Guide\).md).  
