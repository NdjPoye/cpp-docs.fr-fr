...
Le [TextFieldParser Object](../Topic/TextFieldParser%20Object.md) ne peut pas lire le flux qui lui a été passé. Cela peut provenir d’une tentative de lecture d’un fichier qui n’est pas un fichier texte.  
