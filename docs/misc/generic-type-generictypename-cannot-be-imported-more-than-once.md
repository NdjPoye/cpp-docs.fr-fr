...
Un [Imports Statement \(.NET Namespace and Type\)](../Topic/Imports%20Statement%20\(.NET%20Namespace%20and%20Type\).md) spécifie un type générique qui a déjà été importé avec un paramétrage de type différent.  
