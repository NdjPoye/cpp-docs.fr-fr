...
Le délégué 'délégué' utilise des arguments non valides  
 ...
 Le type d’un argument passé à un appel de [délégué](../Topic/delegate%20\(C%23%20Reference\).md) ne correspond pas au type du paramètre dans la déclaration du délégué.  
