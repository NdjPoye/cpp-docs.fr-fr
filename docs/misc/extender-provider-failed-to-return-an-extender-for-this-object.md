...
Aucun extendeur n'a pu être retourné.  
  
### Pour corriger cette erreur  
  
1.  Vérifiez que votre implémentation de IExtenderProvider::CanExtend\(\) et de IExtenderProvider::GetExtender\(\) a réussi à retourner un objet Extender valide.  
