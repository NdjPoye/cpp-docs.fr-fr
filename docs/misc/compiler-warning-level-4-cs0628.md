...
'membre' : nouveau membre protected déclaré dans une classe sealed  
 ...
 Une classe [sealed](../Topic/sealed%20\(C%23%20Reference\).md) ne peut pas introduire un membre [protected](../Topic/protected%20\(C%23%20Reference\).md), car aucune autre classe ne pourra hériter de la classe `sealed`et utiliser le membre `protected`.  
