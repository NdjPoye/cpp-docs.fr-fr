...
Bloc switch vide  
 ...
 Le compilateur a détecté un bloc [switch](../Topic/switch%20\(C%23%20Reference\).md) sans aucune instruction **case** ou **default**. Or, un bloc `switch` doit avoir une ou plusieurs instructions **case** ou **default**.  
