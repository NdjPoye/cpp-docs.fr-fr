...
Une déclaration de propriété `ReadOnly` spécifie les niveaux d’accès dans [Property Statement](../Topic/Property%20Statement.md) et [Get Statement](../Topic/Get%20Statement.md).  
