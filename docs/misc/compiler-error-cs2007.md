...
Option de ligne de commande non reconnue : 'option'  
 ...
 Une chaîne a été passée au compilateur, mais il ne s’agissait pas d’une [option du compilateur](../Topic/C%23%20Compiler%20Options.md), même si elle commençait par une barre oblique \(\/\).  
