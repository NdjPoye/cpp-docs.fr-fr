...
2.  Si vous souhaitez bénéficier de la fonctionnalité d’un module générique, l’approximation la plus proche est une classe générique. Utilisez une [Class Statement](../Topic/Class%20Statement%20\(Visual%20Basic\).md) au lieu d’une instruction `Module`.  
