...
Aucune surcharge pour 'method' ne correspond au délégué 'delegate'  
 ...
 Vous pouvez corriger cette erreur en ajustant la signature de la méthode ou du délégué. Pour plus d'informations, consultez [Délégués](../Topic/Delegates%20\(C%23%20Programming%20Guide\).md).  
