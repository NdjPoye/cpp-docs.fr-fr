...
'is' et 'as' ne sont pas valides sur les types pointeur  
 ...
 Les mots clés [is](../Topic/is%20\(C%23%20Reference\).md) et [as](../Topic/as%20\(C%23%20Reference\).md) ne sont pas valides pour une utilisation sur les types de pointeurs. Pour plus d'informations, consultez [Pointeurs et code unsafe](../Topic/Unsafe%20Code%20and%20Pointers%20\(C%23%20Programming%20Guide\).md).  
