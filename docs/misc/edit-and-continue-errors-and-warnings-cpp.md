...
|2008|Impossible de charger les symboles de débogage du fichier *file* du module *module*.<br /><br /> Pour résoudre ce problème, régénérez le module spécifié avec la version actuelle de [!INCLUDE[vs_current_short](../misc/includes/vs_current_short_md.md)].|  
  
## Voir aussi  
 [Modifier & Continuer \(Visual C\+\+\)](../Topic/Edit%20and%20Continue%20\(Visual%20C++\).md)   
