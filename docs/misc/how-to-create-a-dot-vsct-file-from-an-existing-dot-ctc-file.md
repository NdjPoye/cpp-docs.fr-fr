...
Vous pouvez créer un fichier .vsct XML à partir d’un fichier source .ctc de table de commande existant. Ainsi, vous pouvez tirer parti du nouveau format du compilateur \(VSTC\) de table de commande [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)] XML.  
...
5.  Dans la fenêtre d’invite de commandes [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)], accédez au répertoire.  
