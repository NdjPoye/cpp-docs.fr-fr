...
'\<fonction\_mathématique1\>' n’est pas déclaré. Cette fonction a été déplacée dans la classe System.Math et s’appelle '\<fonction\_mathématique2\>'.  
 ...
 Plusieurs fonctions qui étaient intrinsèques à [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)] dans les versions précédentes ont été déplacées vers l’espace de noms <xref:System.Math?displayProperty=fullName>. Leurs fonctionnalités sont ainsi plus généralement accessibles à tous les langages de programmation.  
