...
'class' ne dispose pas d’une méthode Main static appropriée  
 ...
 L’option du compilateur [\/main](../Topic/-main%20\(C%23%20Compiler%20Options\).md) a spécifié une classe dans laquelle rechercher une méthode **Main**. Toutefois, la méthode [Main](../Topic/Main\(\)%20and%20Command-Line%20Arguments%20\(C%23%20Programming%20Guide\).md) n’était pas définie correctement.  
