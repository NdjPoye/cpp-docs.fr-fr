...
Une déclaration de propriété `WriteOnly` spécifie les niveaux d’accès dans [Property Statement](../Topic/Property%20Statement.md) et dans [Set Statement](../Topic/Set%20Statement%20\(Visual%20Basic\).md).  
