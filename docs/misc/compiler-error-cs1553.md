...
Déclaration non valide ; utilisez plutôt 'opérateur modificateur \<type\-destination\> \(...'  
 ...
 Le type de retour pour un [opérateur](../Topic/operator%20\(C%23%20Reference\)2.md) doit précéder immédiatement la liste de paramètres, et le *modificateur* est soit `implicit`, soit **explicit**.  
