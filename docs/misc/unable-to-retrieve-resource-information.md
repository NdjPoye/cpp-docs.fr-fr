...
-   Redémarrez [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)].  Si cela ne fonctionne pas, appelez les Services de Support technique de Microsoft pour signaler le problème.  
