...
Disable ou restore attendu  
 ...
 Cette erreur se produit quand une clause \#pragma warning est incorrecte, par exemple si, disable ou restore a été omis. Pour plus d’informations, consultez la rubrique [\#pragma warning](../Topic/%23pragma%20warning%20\(C%23%20Reference\).md).  
