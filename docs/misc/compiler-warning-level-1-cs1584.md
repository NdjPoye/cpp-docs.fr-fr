...
Le commentaire XML sur 'member' comporte une erreur de syntaxe au niveau de l’attribut cref 'invalid\_syntax'  
 ...
 L’un des paramètres passés à une balise pour les commentaires de documentation a une syntaxe non valide. Pour plus d'informations, consultez [Balises recommandées pour les commentaires de documentation](../Topic/Recommended%20Tags%20for%20Documentation%20Comments%20\(C%23%20Programming%20Guide\).md).  
