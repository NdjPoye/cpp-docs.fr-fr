...
'référence' est une référence ambiguë entre 'identificateur' et 'identificateur’  
 ...
 Votre programme contient des directives [using](../Topic/using%20\(C%23%20Reference\).md) pour deux espaces de noms et votre code fait référence à un nom qui apparaît dans les deux espaces de noms.  
