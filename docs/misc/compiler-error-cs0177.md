...
Le paramètre de sortie 'parameter' doit être assigné avant que le contrôle ne quitte la méthode actuelle  
 ...
 Un paramètre marqué avec le mot clé [out](../Topic/out%20\(C%23%20Reference\).md) n’a pas de valeur assignée dans le corps de la méthode. Pour plus d'informations, consultez [Passage de paramètres](../Topic/Passing%20Parameters%20\(C%23%20Programming%20Guide\).md)  
