...
'substitution\_propriété' : substitution impossible, car 'non\_propriété' n’est pas une propriété  
 ...
 Vous avez tenté de substituer un type de données autre qu’une propriété en tant que [propriété](../Topic/Properties%20\(C%23%20Programming%20Guide\).md), ce qui n’est pas autorisé.  
