# [Configuration des programmes C++ 11 pour Windows XP](configuring-programs-for-windows-xp.md)
...
### [Comment : incorporer un manifeste à une application C/C++](how-to-embed-a-manifest-inside-a-c-cpp-application.md)
## [Dépannage d'applications isolées C/C++ et d'assemblys côte à côte](troubleshooting-c-cpp-isolated-applications-and-side-by-side-assemblies.md)
# [Configuration des programmes pour les processeurs 64 bits (Visual C++)](configuring-programs-for-64-bit-visual-cpp.md)
## [Comment : configurer des projets Visual C++ pour cibler des plateformes 64 bits](how-to-configure-visual-cpp-projects-to-target-64-bit-platforms.md)
## [Comment : activer un ensemble d'outils du compilateur Visual C++ 64 bits sur la ligne de commande](how-to-enable-a-64-bit-visual-cpp-toolset-on-the-command-line.md)
...
##### [RUNTIME_FUNCTION, structure](struct-runtime-function.md)
...
#### [Gestionnaire spécifique au langage](language-specific-handler.md)
#### [Déroulement de l'assistance pour MASM](unwind-helpers-for-masm.md)
...
# [DLL en Visual C++](dlls-in-visual-cpp.md)
...
## [Différences entre les applications et les DLL](differences-between-applications-and-dlls.md)
## [Avantages de l'utilisation des DLL](advantages-of-using-dlls.md)
## [Types de DLL](kinds-of-dlls.md)
### [DLL non-MFC : vue d'ensemble](non-mfc-dlls-overview.md)
### [DLL normales liées de manière statique aux MFC](regular-dlls-statically-linked-to-mfc.md)
### [DLL normales liées de manière dynamique aux MFC](regular-dlls-dynamically-linked-to-mfc.md)
### [DLL d'extension : vue d'ensemble](extension-dlls-overview.md)
## [Forum Aux Questions à propos des DLL](dll-frequently-asked-questions.md)
### [Une application multithread peut-elle accéder à une DLL MFC dans différents threads ?](can-a-multithreaded-application-access-an-mfc-dll-in-different-threads-q.md)
### [Une DLL MFC peut-elle créer plusieurs threads ?](can-an-mfc-dll-create-multiple-threads-q.md)
### [Existe-t-il des classes ou des fonctions MFC qui ne peuvent pas être utilisées dans une DLL MFC ?](are-there-any-mfc-classes-or-functions-that-cannot-be-used-in-an-mfc-dll-q.md)
### [Quelles techniques d'optimisation dois-je utiliser pour améliorer les performances de l'application cliente lors du chargement ?](what-optimization-techniques-should-i-use.md)
### [Il y a une fuite de mémoire dans ma DLL régulière, pourtant le code semble correct. Comment trouver cette fuite de mémoire ?](memory-leak-in-my-dll.md)
## [Liaison d'un exécutable à une DLL](linking-an-executable-to-a-dll.md)
### [Méthode de liaison à utiliser](determining-which-linking-method-to-use.md)
### [Liaison implicite](linking-implicitly.md)
### [Liaison explicite](linking-explicitly.md)
## [Initialisation d'une DLL](initializing-a-dll.md)
### [Initialisation de DLL normales](initializing-regular-dlls.md)
### [Initialisation de DLL d'extension](initializing-extension-dlls.md)
### [Initialisation de DLL non-MFC](initializing-non-mfc-dlls.md)
## [Comportement de la bibliothèque runtime](run-time-library-behavior.md)
...
## [États du module d'une DLL normale liée de manière dynamique aux MFC](module-states-of-a-regular-dll-dynamically-linked-to-mfc.md)
## [DLL d'extension](extension-dlls.md)
### [Utilisation de DLL d'extension de type base de données, OLE et sockets dans des DLL normales](using-database-ole-and-sockets-extension-dlls-in-regular-dlls.md)
## [Création d'une DLL de ressource uniquement](creating-a-resource-only-dll.md)
## [Ressources localisées dans des applications MFC : DLL satellites](localized-resources-in-mfc-applications-satellite-dlls.md)
...
## [Procédure pas à pas : compilation d'un programme C sur la ligne de commande](walkthrough-compile-a-c-program-on-the-command-line.md)
...
## [Définition du chemin d'accès et des variables d'environnement pour la génération à partir de la ligne de commande](setting-the-path-and-environment-variables-for-command-line-builds.md)
...
##### [Substitution macro](macro-substitution.md)
...
### [Comment : intégrer les outils personnalisés dans les propriétés du projet](how-to-integrate-custom-tools-into-the-project-properties.md)
### [comment : modifier la version cible de .Net Framework et l'ensemble d'outils de la plateforme](how-to-modify-the-target-framework-and-platform-toolset.md)
