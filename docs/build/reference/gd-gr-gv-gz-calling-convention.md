 ...
 **/Gd**, **/GR**, **GV** et **GZ** ne sont pas compatibles avec [/CLR : safe](../../build/reference/clr-common-language-runtime-compilation.md) ou   **/CLR : pure**. Les options de compilateur **/clr:pure** et **/clr:safe** sont dépréciées dans Visual Studio 2015.  
...
4.  Modifier la **Convention d’appel** propriété.  
