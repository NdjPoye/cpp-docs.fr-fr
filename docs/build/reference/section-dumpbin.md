...
## Notes  
 Cette option limite la sortie aux informations qui se trouvent dans la *section* spécifiée.  Utilisez l'option [\/HEADERS](../../build/reference/headers.md) pour obtenir la liste des sections du fichier.  
