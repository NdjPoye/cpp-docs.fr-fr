...
## Notes  
 Cette option vide la structure IMAGE\_LOAD\_CONFIG\_DIRECTORY, une structure facultative qui est utilisée par le chargeur Windows NT et définie dans WINNT.H.  
