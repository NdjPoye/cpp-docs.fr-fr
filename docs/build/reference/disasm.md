...
## Notes  
 Cette option affiche le code machine des sections de code en utilisant les symboles éventuellement présents dans le fichier.  
  
 L'option \/DISASM ne doit être utilisée que sur des images natives \(non managées\).  
