...
Cette section décrit le processus d'appel d'une fonction \(appelé\) par une autre fonction \(appelante\).  
  
 Pour les fonctions prototypées, tous les arguments sont convertis en les types appelés attendus avant leur passage.  
