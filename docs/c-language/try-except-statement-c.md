...
helpviewer_keywords: 
  - "__except (mot clé) (C)"
  - "__except (mot clé) (C), dans try-except"
  - "__try (mot clé) (C)"
  - "gestion structurée des exceptions, try-except"
  - "try-catch (mot clé) (C)"
...
3.  Si une exception se produit pendant l'exécution de la section protégée ou dans toute routine appelée par la section protégée, l'expression `__except` est évaluée et la valeur retournée détermine comment l'exception est gérée.  Il existe trois valeurs :  
