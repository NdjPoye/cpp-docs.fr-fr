...
dev_langs: 
  ...
  - "C"
helpviewer_keywords: 
  - "assigner des valeurs en C"
  - "opérateurs d'assignation, assigner des valeurs dans des expressions"
  - "instructions d'assignation, valeurs dans des expressions"
  - "expressions (C)"
  - "expressions (C), assigner des valeurs"
  - "opérateurs (C), assigner des valeurs"
  - "Visual C, assignations"
...
-   [Conversions de types](../c-language/type-conversions-c.md)  
