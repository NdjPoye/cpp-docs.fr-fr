...
et via le type 'type'  
 ...
 Cette suite de l’avertissement [C4281](../../error-messages/compiler-warnings/compiler-warning-level-3-c4281.md) montre que **opérateur->** s’appelle elle-même via `type`.
