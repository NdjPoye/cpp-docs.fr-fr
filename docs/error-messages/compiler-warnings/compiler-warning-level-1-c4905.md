---
title: "Avertissement du compilateur (niveau 1) C4905 | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
---
# Avertissement du compilateur (niveau 1) C4905
[!INCLUDE[vs2017banner](../../assembler/inline/includes/vs2017banner.md)]

cast de littéral de chaîne étendu en 'LPSTR'  
  
 Le compilateur a détecté un cast non sécurisé.  Le cast a réussi, mais vous devriez utiliser une routine de conversion.  
...
## Exemple  
 L'exemple suivant génère l'erreur C4905 :  
