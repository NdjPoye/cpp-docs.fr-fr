...
|Erreur irrécupérable C1016|#un identificateur était attendu / # ifdef ifndef|  
...
|[Erreur irrécupérable C1113](../../error-messages/compiler-errors-1/fatal-error-c1113.md)|#Échec de '`file`'|  
...
|[Erreur irrécupérable C1192](../../error-messages/compiler-errors-1/fatal-error-c1192.md)|#Échec de '`file`'|  
