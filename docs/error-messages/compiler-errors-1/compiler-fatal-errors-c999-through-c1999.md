...
|[Erreur irrécupérable C1003](../../error-messages/compiler-errors-1/fatal-error-c1003.md)|nombre d’erreurs dépasse *nombre*; arrêt de la compilation|  
...
|Erreur irrécupérable C1077|limite du compilateur : ne peut pas avoir plus de *nombre* les options de ligne de commande|  
