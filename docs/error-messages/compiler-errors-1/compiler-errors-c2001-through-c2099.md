...
|[Erreur du compilateur C2005](compiler-error-c2005.md)|#ligne attendait un numéro de ligne, trouvé '*jeton*'|  
|[Erreur du compilateur C2006](compiler-error-c2006.md)|'*directive*' : attendu d’un nom de fichier, trouvé '*jeton*'|  
|[Erreur du compilateur C2007](compiler-error-c2007.md)|#définition de syntaxe|  
...
|[Erreur du compilateur C2014](compiler-error-c2014.md)|une commande de préprocesseur doit commencer comme premier espace autre que blanc|  
...
|[Erreur du compilateur C2041](compiler-error-c2041.md)|chiffre non conforme '*caractère*'pour la base de'*numéro*'|  
...
|[Erreur du compilateur C2051](compiler-error-c2051.md)|l'expression associée à case n'est pas une constante|  
...
|[Erreur du compilateur C2055](compiler-error-c2055.md)|liste de paramètres formels attendue, non une liste de types|  
...
|[Erreur du compilateur C2060](compiler-error-c2060.md)|erreur de syntaxe : fin de fichier rencontrée|  
...
|[Erreur du compilateur C2090](compiler-error-c2090.md)|tableau retourné par la fonction|  
|[Erreur du compilateur C2091](compiler-error-c2091.md)|fonction retournée par la fonction|  
