...
'spécificateurs_attributs' : aucune version, culture ou architecture de processeur ne peut être spécifiée pour les déclarations InternalsVisible  
 ...
 Le <xref:System.Runtime.CompilerServices.InternalsVisibleToAttribute>attribut n’a pas été spécifié correctement.</xref:System.Runtime.CompilerServices.InternalsVisibleToAttribute>  
