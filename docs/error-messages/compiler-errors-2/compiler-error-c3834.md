...
---
# Erreur du compilateur C3834
[!INCLUDE[vs2017banner](../../assembler/inline/includes/vs2017banner.md)]

cast explicite non conforme vers un pointeur épinglé ; utilisez une variable locale épinglée à la place  
  
 Les casts explicites vers un pointeur épinglé ne sont pas autorisés.  
  
## Exemple  
 L'exemple suivant génère l'erreur C3834.  
