...
|[Erreur du compilateur C3104](compiler-error-c3104.md)|argument non conforme pour l'attribut|  
...
|C3108 d’erreur du compilateur|impossible de déduire un type, car une liste d'initialiseurs n'est pas une expression|  
...
|C3111 d’erreur du compilateur|Une liste d'initialiseurs ne peut pas être utilisée en tant qu'argument par défaut pour un paramètre de modèle|  
...
|C3119 d’erreur du compilateur|alignas(void) n'est pas autorisé|  
...
|C3123 d’erreur du compilateur|une interface générique WinRT ne peut pas avoir de contraintes|  
...
|[Erreur du compilateur C3167](compiler-error-c3167.md)|Impossible d'initialiser le .NET Framework : vérifiez qu'il est bien installé|  
...
|[Erreur du compilateur C3174](compiler-error-c3174.md)|attribut module non spécifié|  
...
|[Erreur du compilateur C3180](compiler-error-c3180.md)|'*type*' : nom dépasse la limite métadonnées de '*numéro*' caractères|  
...
|[Erreur du compilateur C3199](compiler-error-c3199.md)|utilisation non valide des pragmas à virgule flottante : les exceptions ne sont pas prises en charge en mode sans précision|  
