...
|C3446 d’erreur du compilateur|'*classe*' : un initialiseur de membre par défaut n’est pas autorisé pour un membre d’une classe value|  
...
|C3479 d’erreur du compilateur|les annotations SAL sur les expressions lambda ne sont pas prises en charge|  
...
|C3497 d’erreur du compilateur|vous ne pouvez pas construire une instance d'expression lambda|  
