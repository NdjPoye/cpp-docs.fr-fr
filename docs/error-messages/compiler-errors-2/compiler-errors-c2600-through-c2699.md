...
|[Erreur du compilateur C2645](compiler-error-c2645.md)|aucun nom qualifié pour un pointeur vers un membre (trouvé ' :: *')|  
...
|[Erreur du compilateur C2660](compiler-error-c2660.md)|'*fonction*' : fonction n’accepte pas *numéro* arguments|  
...
|[Erreur du compilateur C2663](compiler-error-c2663.md)|'*fonction*' : *numéro* surcharges n’ont pas de conversion autorisée pour le pointeur 'this'|  
...
|C2686 d’erreur du compilateur|impossible de surcharger les fonctions membres static et non static avec les mêmes types de paramètres|  
