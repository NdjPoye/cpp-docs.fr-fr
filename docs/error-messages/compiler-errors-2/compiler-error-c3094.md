...
'attribut' : utilisation anonyme non autorisée  
 ...
 La portée d’un attribut a été définie de manière incorrecte.  Pour plus d’informations, consultez [les attributs définis par l’utilisateur](../../windows/user-defined-attributes-cpp-component-extensions.md).  
