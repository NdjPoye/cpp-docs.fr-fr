...
|C3512 d’erreur du compilateur|la séquence de caractères de délimitation pour un littéral de chaîne brute ne doit pas contenir plus de 16 caractères|  
...
|C3515 d’erreur du compilateur|si un argument pour une spécialisation partielle de modèle de classe est une expansion de package, il s'agira du dernier argument|  
