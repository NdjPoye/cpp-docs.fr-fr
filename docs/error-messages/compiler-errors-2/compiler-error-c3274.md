...
__finally/finally sans try correspondant  
 ...
 A [__finally](../../cpp/try-finally-statement.md) ou [enfin](../../dotnet/finally.md) instruction a été trouvée sans `try`. Pour résoudre ce problème, supprimez l’instruction `__finally` ou ajoutez une instruction `try` pour `__finally`.  
