---
title: "Contr&#244;les ActiveX MFC&#160;: rubriques avanc&#233;es | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
helpviewer_keywords: 
  - "FireError (méthode)"
  - "contrôles ActiveX MFC, accéder aux contrôles de boîte de dialogue invisibles"
  - "contrôles ActiveX MFC, rubriques avancées"
  - "contrôles ActiveX MFC, classes de base de données"
  - "contrôles ActiveX MFC, codes d'erreur"
  - "contrôles ActiveX MFC, propriété paramétrée"
  - "contrôles ActiveX MFC, touches spéciales"
...
This article covers advanced topics related to developing ActiveX controls.  Ces niveaux sont les suivants :  
...
> [!NOTE]
>  Dans Visual C\+\+ .NET, les Assistants et l'environnement Visual C\+\+ ne prennent plus en charge DAO \(même si les classes DAO sont incluses et que vous pouvez toujours les utiliser\).  Microsoft recommends that you use [OLE DB Templates](../data/oledb/ole-db-programming.md) or [ODBC and MFC](../data/odbc/odbc-and-mfc.md) for new projects.  Vous ne devez utiliser DAO que dans les applications existantes.  
...
|**CTL\_E\_OVERFLOW**|Dépassement de capacité|  
|**CTL\_E\_OUTOFMEMORY**|Mémoire insuffisante|  
...
|**CTL\_E\_REPLACEMENTSTOOLONG**|Replacements too long|  
 ...
 If necessary, use the **CUSTOM\_CTL\_SCODE** macro to define a custom error code for a condition that is not covered by one of the standard codes.  The parameter for this macro should be an integer between 1000 and 32767, inclusive.  Par exemple :  
