...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "CListCtrl (classe), réorganiser la liste"
  - "CListCtrl (classe), rechercher des éléments dans"
  - "CListCtrl (classe), défilement"
  - "CListCtrl (classe), trier"
  - "listes d'images (C++), réorganiser"
  - "listes d'images (C++), rechercher des éléments"
  - "listes d'images (C++), défilement"
  - "listes d'images (C++), trier"
...
---
# D&#233;filement, organisation, tri et recherche dans les contr&#244;les de liste
