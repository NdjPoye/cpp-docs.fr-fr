...
helpviewer_keywords: 
  ...
  - "exemples (MFC), boîtes de dialogue"
  - "éléments de menu, exemples"
  - "boîtes de dialogue MFC, afficher"
  - "boîtes de dialogue MFC, exemples"
  - "boîtes de dialogue modales, afficher"
...
|Élément|Name or value|  
|-------------|-------------------|  
|Application|DisplayDialog|  
|Menu command|Test command on View menu; Command ID \= ID\_VIEW\_TEST|  
|Boîte de dialogue|Test dialog box; Class \= CTestDialog; Header file \= TestDialog.h; Variable \= testdlg, ptestdlg|  
