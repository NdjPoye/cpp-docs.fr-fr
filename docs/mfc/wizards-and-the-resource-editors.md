...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "Assistants Application (C++), et MFC"
  - "Affichage de classes (outil), gérer les messages Windows"
  - "éditeurs, ressource"
  - "MFC (C++), éditeurs de ressources"
  - "MFC (C++), Assistants"
  - "Assistant Application MFC"
  - "éditeurs de ressources, MFC"
  - "Assistants (C++), programmer MFC"
  - "Assistants (MFC)"
