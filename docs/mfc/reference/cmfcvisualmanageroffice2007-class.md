...
|`CMFCVisualManagerOffice2007::GetStyle`|Retourne le jeu de couleurs de la `CMFCVisualManagerOffice2007` GUI qui, à son tour, reproduit l’interface utilisateur de Microsoft Office 2007.|  
...
|`CMFCVisualManagerOffice2007::SetStyle`|Définit le jeu de couleurs de la `CMFCVisualManagerOffice2007` GUI.|  
  
## <a name="remarks"></a>Remarques  
 Utilisez `CMFCVisualManagerOffice2007` pour modifier l’apparence visuelle de votre application ressemble à celle de Microsoft Office 2007. Ce gestionnaire visuel nécessite que vous affectez au style avant de l’utiliser. Avant de passer ce gestionnaire visuel pour `CMFCVisualManager::SetDefaultManager`, vous devez appeler la fonction statique `CMFCVisualManagerOffice2007::SetStyle`.  
  
## <a name="example"></a>Exemple  
 L’exemple suivant montre comment utiliser le Gestionnaire visuel Office 2007. Cet extrait de code fait partie de la [exemple de démonstration alerte bureau](../../visual-cpp-samples.md).  
