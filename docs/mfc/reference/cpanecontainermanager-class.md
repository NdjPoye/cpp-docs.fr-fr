...
### <a name="remarks"></a>Remarques  
 L’infrastructure crée automatiquement des instances de `CPaneContainerManager` les objets et les incorpore soit en [CPaneDivider classe](../../mfc/reference/cpanedivider-class.md) objets ou en [CMultiPaneFrameWnd classe](../../mfc/reference/cmultipaneframewnd-class.md) objets.  
