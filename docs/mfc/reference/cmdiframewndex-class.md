---
title: CMDIFrameWndEx Class | Documents Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Étend les fonctionnalités de [CMDIFrameWnd](../../mfc/reference/cframewnd-class.md), une fenêtre frame de Windows Interface MDI (Multiple Document).  
...
|[CMDIFrameWndEx::AddPane](#addpane)|Enregistre un volet avec le Gestionnaire d’ancrage.|  
...
|[CMDIFrameWndEx::AreMDITabs](#aremditabs)|Détermine si la fonctionnalité onglets MDI ou les groupes d’onglets MDI est activé.|  
|[CMDIFrameWndEx::CanCovertControlBarToMDIChild](#cancovertcontrolbartomdichild)|Appelé par l’infrastructure pour déterminer si la fenêtre frame peut convertir des volets d’ancrage pour les documents avec onglet.|  
|[CMDIFrameWndEx::ControlBarToTabbedDocument](#controlbartotabbeddocument)|Convertit le volet d’ancrage spécifié dans un document à onglets.|  
...
|[CMDIFrameWndEx::EnableAutoHidePanes](#enableautohidepanes)|Permet de masquer le mode des volets lorsqu’elles sont ancrées sur les côtés spécifiées de la fenêtre frame principale.|  
...
|[CMDIFrameWndEx::EnableMDITabbedGroups](#enablemditabbedgroups)|Active ou désactive la fonctionnalité des groupes avec onglet MDI.|  
|[CMDIFrameWndEx::EnableMDITabs](#enablemditabs)|Active ou désactive la fonctionnalité onglets MDI. Lorsque activé, la fenêtre frame affiche un onglet pour chaque fenêtre MDI enfant.|  
...
|[CMDIFrameWndEx::GetMDITabsContextMenuAllowedItems](#getmditabscontextmenualloweditems)|Retourne une combinaison d’indicateurs qui détermine les éléments de menu contextuel sont valides lorsque la fonctionnalité des groupes avec onglet MDI est activée.|  
|[CMDIFrameWndEx::GetMenuBar](#getmenubar)|Retourne un pointeur vers un objet de barre de menu associé à la fenêtre frame.|  
|[CMDIFrameWndEx::GetRibbonBar](#getribbonbar)|Récupère le contrôle de barre de ruban de l’image.|  
|[CMDIFrameWndEx::GetTearOffBars](#gettearoffbars)|Retourne une liste de [CPane](../../mfc/reference/cpane-class.md)-dérivée objets qui se trouvent dans un état détachables.|  
|`CMDIFrameWndEx::GetThisClass`|Appelé par le framework d’obtenir un pointeur vers le [CRuntimeClass](../../mfc/reference/cruntimeclass-structure.md) objet associé à ce type de classe.|  
...
|[CMDIFrameWndEx::IsMDITabbedGroup](#ismditabbedgroup)|Détermine si la fonctionnalité des groupes avec onglet MDI est activée.|  
|[CMDIFrameWndEx::IsMemberOfMDITabGroup](#ismemberofmditabgroup)|Détermine si la fenêtre à onglets spécifiée se trouve dans la liste des fenêtres qui se trouvent dans des groupes avec onglet MDI.|  
|[CMDIFrameWndEx::IsMenuBarAvailable](#ismenubaravailable)|Détermine si la fenêtre frame comporte une barre de menus.|  
...
|[CMDIFrameWndEx::LoadMDIState](#loadmdistate)|Charge la disposition des groupes d’onglets MDI spécifiée et la liste des documents précédemment ouverts.|  
|[CMDIFrameWndEx::MDITabMoveToNextGroup](#mditabmovetonextgroup)|Déplace l’onglet actif à partir de la fenêtre à onglets active pour le groupe d’onglets suivant ou précédent.|  
|[CMDIFrameWndEx::MDITabNewGroup](#mditabnewgroup)|Crée un nouveau groupe d’onglets qui a une seule fenêtre.|  
|[CMDIFrameWndEx::NegotiateBorderSpace](#negotiateborderspace)|Lors de l’activation sur place OLE, négocie espace bordure dans une fenêtre frame.|  
|[CMDIFrameWndEx::OnCloseDockingPane](#onclosedockingpane)|Appelé par l’infrastructure lorsque l’utilisateur clique sur le **fermer** bouton dans un volet Ancrable.|  
|[CMDIFrameWndEx::OnCloseMiniFrame](#oncloseminiframe)|Appelé par l’infrastructure lorsque l’utilisateur clique sur le **fermer** bouton sur une fenêtre frame mini flottante.|  
...
|[CMDIFrameWndEx::OnCmdMsg](#oncmdmsg)|Appelé par l’infrastructure pour router et distribuer des messages de commande et mettre à jour les objets d’interface utilisateur de commande.|  
...
|[CMDIFrameWndEx::OnEraseMDIClientBackground](#onerasemdiclientbackground)|Appelé par l’infrastructure lorsque l’interface MDI frame processus de fenêtre un `WM_ERASEBKGND` message.|  
...
|[CMDIFrameWndEx::OnShowCustomizePane](#onshowcustomizepane)|Appelé par l’infrastructure lorsqu’un volet Personnalisation rapide est activé.|  
|[CMDIFrameWndEx::OnShowMDITabContextMenu](#onshowmditabcontextmenu)|Appelé par l’infrastructure lorsqu’un menu contextuel doit être affiché sur un des onglets. (Valable pour les groupes avec onglet MDI uniquement).|  
|[CMDIFrameWndEx::OnShowPanes](#onshowpanes)|Appelé par l’infrastructure pour afficher ou masquer les volets.|  
...
|`CMDIFrameWndEx::PreTranslateMessage`|Utilisé par la classe [CWinApp](../../mfc/reference/cwinapp-class.md) pour convertir des messages de fenêtre avant qu’ils soient distribués à le [TranslateMessage](http://msdn.microsoft.com/library/windows/desktop/ms644955) et [DispatchMessage](http://msdn.microsoft.com/library/windows/desktop/ms644934) fonctions de Windows.  (Substitue `CMDIFrameWnd::PreTranslateMessage`.)|  
|[CMDIFrameWndEx::RecalcLayout](#recalclayout)|Appelée par l’infrastructure pour recalculer la disposition de la fenêtre frame. (Substitue [CFrameWnd::RecalcLayout](../../mfc/reference/cframewnd-class.md#recalclayout).)|  
|[CMDIFrameWndEx::RemovePaneFromDockManager](#removepanefromdockmanager)|Annule l’inscription d’un volet et elle supprime le Gestionnaire d’ancrage.|  
|[CMDIFrameWndEx::SaveMDIState](#savemdistate)|Enregistre la disposition actuelle des groupes d’onglets MDI et la liste des documents précédemment ouverts.|  
...
|[CMDIFrameWndEx::TabbedDocumentToControlBar](#tabbeddocumenttocontrolbar)|Convertit le document à onglets spécifié à un volet d’ancrage.|  
|[CMDIFrameWndEx::UpdateCaption](#updatecaption)|Appelé par l’infrastructure pour mettre à jour la légende de la fenêtre frame.|  
...
|Nom|Description|  
|----------|-----------------|  
|[CMDIFrameWndEx::m_bCanCovertControlBarToMDIChild](#m_bcancovertcontrolbartomdichild)|Détermine si les volets d’ancrage peuvent devenir des fenêtres enfants MDI.|  
...
### <a name="return-value"></a>Valeur de retour  
 Retourne une valeur différente de zéro si le volet est correctement inscrit. Retourne 0 si le volet est déjà inscrit avec le Gestionnaire d’ancrage.  
  
### <a name="remarks"></a>Remarques  
 Chaque volet doit être enregistré avec le [CDockingManager classe](../../mfc/reference/cdockingmanager-class.md) avant que peut prendre une partie de la mise en page d’accueil. Utilisez cette méthode pour informer le Gestionnaire d’ancrage que vous souhaitez ancrer un volet spécifique. Une fois ce volet est enregistré, le Gestionnaire d’ancrage s’aligne en fonction de son paramètre d’alignement et de position dans la liste de volets maintenue par le Gestionnaire d’ancrage.  
...
### <a name="remarks"></a>Remarques  
 Appelez cette fonction membre pour recalculer la disposition de tous les volets ancrée à la fenêtre frame.  
  
##  <a name="a-namearemditabsa--cmdiframewndexaremditabs"></a><a name="aremditabs"></a>CMDIFrameWndEx::AreMDITabs  
 Détermine si la fonctionnalité d’onglets MDI ou les groupes avec onglet MDI est activé.  
...
### <a name="parameters"></a>Paramètres  
 [out] `pnMDITabsType`  
 Pointeur vers une variable de type entier qui indique les fonctionnalités qui sont activées :  
...
### <a name="return-value"></a>Valeur de retour  
 `Returns TRUE`Si les onglets MDI ou MDI avec onglets groupes sont activé.  
  
 `Returns FALSE`Si aucune des fonctionnalités ci-dessus est activé.  
  
### <a name="remarks"></a>Notes  
 Utilisez cette fonction pour déterminer si les onglets MDI ou MDI avec onglets groupes est activée pour la fenêtre frame. Utilisez [CMDIFrameWndEx::EnableMDITabs](#enablemditabs) pour activer ou désactiver la fonctionnalité onglets MDI.  
...
##  <a name="a-namecancovertcontrolbartomdichilda--cmdiframewndexcancovertcontrolbartomdichild"></a><a name="cancovertcontrolbartomdichild"></a>CMDIFrameWndEx::CanCovertControlBarToMDIChild  
 Appelé par l’infrastructure pour déterminer si la fenêtre frame peut convertir des volets d’ancrage pour les documents avec onglet  
...
### <a name="return-value"></a>Valeur de retour  
 Retourne `TRUE` si la fenêtre frame peut convertir des volets d’ancrage pour les documents avec onglet ; sinon, retourne `FALSE`.  
  
### <a name="remarks"></a>Notes  
 Substituez cette méthode dans une classe dérivée et retourner `TRUE` pour activer la conversion des volets d’ancrage pour les documents avec onglet. Vous pouvez également définir [CMDIFrameWndEx::m_bCanCovertControlBarToMDIChild](#m_bcancovertcontrolbartomdichild) à `TRUE`.  
...
##  <a name="a-namecontrolbartotabbeddocumenta--cmdiframewndexcontrolbartotabbeddocument"></a><a name="controlbartotabbeddocument"></a>CMDIFrameWndEx::ControlBarToTabbedDocument  
 Convertit le volet d’ancrage spécifié dans un document à onglets.  
...
### <a name="remarks"></a>Notes  
 Cette méthode convertit un volet d’ancrage à un document à onglets. Lorsque vous appelez cette méthode, l’infrastructure crée un [classe CMDIChildWndEx](../../mfc/reference/cmdichildwndex-class.md) objet supprime le volet d’ancrage dans le Gestionnaire d’ancrage et ajoute le volet d’ancrage à la fenêtre enfant MDI. La fenêtre MDI enfant redimensionne le volet d’ancrage pour couvrir toute la zone cliente  
...
### <a name="parameters"></a>Paramètres  
 ...
 [in] `pObj`  
 Pointeur vers un objet défini par l’utilisateur. Par exemple, un développeur peut créer une structure de données spécifiques aux applications décrivant le document et en indiquant comment le document doit être initialisé au démarrage.  
...
### <a name="example"></a>Exemple  
 L’exemple suivant montre comment `CreateDocumentWindow` est utilisée dans les [exemple VisualStudioDemo : Application MFC de Visual Studio](../../visual-cpp-samples.md).  
...
### <a name="example"></a>Exemple  
 L'exemple suivant illustre l'utilisation de la méthode `DockPane`. Cet extrait de code provient de la [exemple VisualStudioDemo : Application MFC de Visual Studio](../../visual-cpp-samples.md).  
...
### <a name="parameters"></a>Paramètres  
 ...
 [in] `pLeftOf`  
 Pointeur vers le volet qui sert de site d’ancrage. .  
...
### <a name="example"></a>Exemple  
 L’exemple suivant montre comment la `DockPaneLeftOf` méthode est utilisée dans les [exemple VisualStudioDemo : Application MFC de Visual Studio](../../visual-cpp-samples.md).  
...
##  <a name="a-nameenableautohidepanesa--cmdiframewndexenableautohidepanes"></a><a name="enableautohidepanes"></a>CMDIFrameWndEx::EnableAutoHidePanes  
 Permet de masquer en mode volets de lorsqu’elles sont ancrées sur les côtés spécifiées de la fenêtre frame principale.  
...
### <a name="example"></a>Exemple  
 L’exemple suivant montre comment la `EnableAutoHidePanes` méthode est utilisée dans les [exemple VisualStudioDemo : Application MFC de Visual Studio](../../visual-cpp-samples.md).  
  
 [!code-cpp[NVC_MFC_VisualStudioDemo n °&6;](../../mfc/codesnippet/cpp/cmdiframewndex-class_5.cpp)]  
...
### <a name="example"></a>Exemple  
 L’exemple suivant montre comment la `EnableDocking` méthode est utilisée dans les [exemple VisualStudioDemo : Application MFC de Visual Studio](../../visual-cpp-samples.md).  
...
### <a name="parameters"></a>Paramètres  
 [in] `bEnableMenu`  
 `TRUE`Pour afficher le menu principal en mode plein écran, ou `FALSE` pour la masquer.  
...
### <a name="parameters"></a>Paramètres  
 [in] `uiFullScreenCmd`  
 L’ID de commande qui active ou désactive le mode plein écran.  
  
### <a name="remarks"></a>Remarques  
 En mode plein écran, toutes les barres de contrôles d’ancrage, les barres d’outils et les menus sont masqués et la vue active est redimensionnée pour occuper le mode plein écran. Lorsque vous activez le mode plein écran, vous devez spécifier un ID de la commande qui active ou désactive. Vous pouvez appeler `EnableFullScreenMode` à partir du frame principal `OnCreate` (fonction). Lorsqu’une fenêtre frame en cours bascule en mode plein écran, l’infrastructure crée une barre d’outils flottante avec un seul bouton qui possède l’ID de commande spécifié. Si vous souhaitez conserver le menu principal sur l’écran, appelez [CMDIFrameWndEx::EnableFullScreenMainMenu](#enablefullscreenmainmenu).  
...
### <a name="parameters"></a>Paramètres  
 ...
 [in] `params`  
 Spécifie les paramètres qui le framework s’applique aux fenêtres enfants qui sont créés dans la zone cliente MDI.  
  
### <a name="remarks"></a>Remarques  
 Utilisez cette méthode pour activer ou désactiver la fonctionnalité de groupes avec onglet MDI. Cette fonctionnalité permet aux applications MDI afficher sous forme de fenêtres à onglets alignés verticalement ou horizontalement dans la zone cliente MDI des fenêtres enfants. Les groupes de fenêtres avec onglet sont séparés par des séparateurs. L’utilisateur peut redimensionner les groupes avec onglet à l’aide d’un séparateur.  
...
-   Déplacer des onglets ou créer des groupes à l’aide d’un menu contextuel.  
...
-   Votre application peut enregistrer la disposition de fenêtres actuelle et la liste des documents actuellement ouverts.  
 ...
 Pour plus d’informations sur l’utilisation de MDI avec onglets groupes, consultez [groupes avec onglet MDI](../../mfc/mdi-tabbed-groups.md).  
  
### <a name="example"></a>Exemple  
 L’exemple suivant montre comment `EnableMDITabbedGroups` est utilisée dans les [exemple VisualStudioDemo : Application MFC de Visual Studio](../../visual-cpp-samples.md).  
...
##  <a name="a-nameenablemditabsa--cmdiframewndexenablemditabs"></a><a name="enablemditabs"></a>CMDIFrameWndEx::EnableMDITabs  
 Active ou désactive la fonctionnalité onglets MDI de la fenêtre frame MDI. Lorsque activé, la fenêtre frame affiche un onglet pour chaque fenêtre MDI enfant.  
...
### <a name="parameters"></a>Paramètres  
 ...
 `bIcons`  
 Spécifie si des icônes doivent être affichées sous les onglets.  
  
 `tabLocation`  
 Spécifie l’emplacement des étiquettes de l’onglet.  
 ...
 Si `TRUE`, un **fermer** bouton s’affiche sous l’onglet actif plutôt que sur la droite de la zone de l’onglet.  
  
### <a name="remarks"></a>Remarques  
 Appelez cette méthode pour activer ou désactiver la fonctionnalité onglets MDI de la fenêtre frame MDI. Lorsque activé, toutes les fenêtres enfants sont affichés sous forme d’onglets.  
  
 Les étiquettes de l’onglet peuvent être situés en haut ou en bas de l’image, selon la valeur du paramètre `tabLocation`. Vous pouvez spécifier `CMFCTabCtrl::LOCATION_BOTTOM` (paramètre par défaut) ou `CMFCTabCtrl::LOCATION_TOP`.  
  
 Si `bTabCustomTooltips` est `TRUE`, un `AFX_WM_ON_GET_TAB_TOOLTIP` message sera envoyé à la fenêtre frame principale. Votre code peut traiter ce message et fournir l’infrastructure des info-bulles personnalisées pour les onglets MDI.  
  
### <a name="example"></a>Exemple  
 L’exemple suivant montre comment `EnableMDITabs` est utilisée dans le [exemple MDITabsDemo : Application de MDI avec onglets MFC](../../visual-cpp-samples.md).  
...
### <a name="parameters"></a>Paramètres  
 [in] `bEnable`  
 Si `TRUE`, la gestion automatique du menu volet est activée ; si `FALSE`, la gestion automatique est désactivée.  
 ...
 Spécifie l’ID d’un élément de menu de barre d’outils qui ouvre le menu du volet. Il s’agit généralement du **barres d’outils** sous-menu de la **affichage** menu.  
...
### <a name="example"></a>Exemple  
 L’exemple suivant montre comment `EnablePaneMenu` est utilisée dans les [exemple VisualStudioDemo : Application MFC de Visual Studio](../../visual-cpp-samples.md).  
...
### <a name="remarks"></a>Remarques  
 Utilisez cette méthode pour insérer un élément de menu dont commande appelle une boîte de dialogue de gestion de fenêtre MDI enfant ( [CMFCWindowsManagerDialog classe](../../mfc/reference/cmfcwindowsmanagerdialog-class.md)). Le nouvel élément est inséré dans le menu spécifié par `uiMenuId`. Appelez `EnableWindowsDialog` lorsque vous traitez le `WM_CREATE` message.  
  
### <a name="example"></a>Exemple  
 L’exemple suivant montre comment `EnableWindowsDialog` est utilisée dans les [exemple VisualStudioDemo : Application MFC de Visual Studio](../../visual-cpp-samples.md).  
...
### <a name="return-value"></a>Valeur de retour  
 Un pointeur vers le menu contextuel active ; `NULL` si aucune fenêtre contextuelle n’est active.  
...
### <a name="remarks"></a>Remarques  
 Cette méthode retourne l’ID de ressource spécifié lors de la fenêtre frame MDI a été chargée par [CFrameWnd::LoadFrame](../../mfc/reference/cframewnd-class.md#loadframe).  
...
### <a name="return-value"></a>Valeur de retour  
 Une référence à un [CObList classe](../../mfc/reference/coblist-class.md) objet qui contient une liste de fenêtres. Ne stockez pas ni modifier la liste.  
  
### <a name="remarks"></a>Notes  
 Utilisez cette méthode pour accéder à la liste des fenêtres à onglets. Il peut être utile si vous souhaitez modifier ou interroger des paramètres des onglets individuels.  
...
##  <a name="a-namegetmditabscontextmenualloweditemsa--cmdiframewndexgetmditabscontextmenualloweditems"></a><a name="getmditabscontextmenualloweditems"></a>CMDIFrameWndEx::GetMDITabsContextMenuAllowedItems  
 Retourne une combinaison d’indicateurs qui détermine quelles opérations sont valides lorsque la fonctionnalité des groupes avec onglet MDI est activée.  
...
- `BCGP_MDI_CAN_MOVE_PREV`-peut déplacer un onglet au groupe d’onglets précédent.  
  
- `BCGP_MDI_CAN_MOVE_NEXT`-peut déplacer un onglet au groupe d’onglets suivant.  
  
### <a name="remarks"></a>Remarques  
 Lorsque la fonctionnalité des groupes avec onglet MDI est activée, vous devez savoir quelles opérations sont autorisées sur les onglets d’une fenêtre donnée. Cette méthode analyse la disposition de fenêtres actuelle et retourne une combinaison d’indicateurs qui peuvent être utilisées pour créer, par exemple, un menu contextuel.  
  
 Vous pouvez créer un nouveau groupe d’onglets vertical lorsque toutes les fenêtres sont alignées verticalement, ou lorsqu’il existe une seule fenêtre à onglets.  
  
 Vous pouvez créer un nouveau groupe d’onglets horizontal lorsque toutes les fenêtres sont alignés horizontalement ou lors d’une seule fenêtre à onglets.  
  
 Vous pouvez déplacer un onglet au groupe précédent uniquement s’il existe plusieurs onglets dans une fenêtre à onglets.  
  
 Vous pouvez déplacer un onglet au groupe uniquement s’il existe plusieurs onglets dans une fenêtre à onglets.  
  
##  <a name="a-namegetmenubara--cmdiframewndexgetmenubar"></a><a name="getmenubar"></a>CMDIFrameWndEx::GetMenuBar  
 Retourne un pointeur vers un objet de barre de menu associé à la fenêtre frame.  
...
### <a name="return-value"></a>Valeur de retour  
 Pointeur vers le volet qui possède l’ID du contrôle spécifié, s’il existe. Sinon, `NULL`.  
  
##  <a name="a-namegetribbonbara--cmdiframewndexgetribbonbar"></a><a name="getribbonbar"></a>CMDIFrameWndEx::GetRibbonBar  
 Récupère le contrôle de barre de ruban de l’image.  
...
### <a name="return-value"></a>Valeur de retour  
 Pointeur vers le [CMFCRibbonBar Class](../../mfc/reference/cmfcribbonbar-class.md) du cadre.  
...
### <a name="return-value"></a>Valeur de retour  
 Une référence à un [CObList classe](../../mfc/reference/coblist-class.md) objet qui contient une collection de pointeurs vers des `CPane`-dérivée objets qui se trouvent dans un état détachables.  
...
### <a name="return-value"></a>Valeur de retour  
 `TRUE`Si la méthode inscrit avec succès, le volet de `FALSE` si celui-ci a déjà été enregistré avec le Gestionnaire d’ancrage.  
  
### <a name="remarks"></a>Remarques  
 Utilisez cette méthode pour informer le Gestionnaire d’ancrage d’un volet spécifié par `pControlBar`. Le Gestionnaire d’ancrage est alignées ce volet selon l’alignement et la position dans la liste interne du Gestionnaire d’ancrage du volet.  
...
##  <a name="a-nameismditabbedgroupa--cmdiframewndexismditabbedgroup"></a><a name="ismditabbedgroup"></a>CMDIFrameWndEx::IsMDITabbedGroup  
 Spécifie si la fonctionnalité des groupes avec onglet MDI est activée.  
...
### <a name="return-value"></a>Valeur de retour  
 `TRUE`Si la fonctionnalité des groupes avec onglet MDI est activée ; dans le cas contraire `FALSE`.  
  
### <a name="remarks"></a>Remarques  
 Pour déterminer si les onglets MDI normaux ou la fonctionnalité des groupes avec onglet MDI est activée, utilisez [CMDIFrameWndEx::AreMDITabs](#aremditabs).  
...
##  <a name="a-nameismemberofmditabgroupa--cmdiframewndexismemberofmditabgroup"></a><a name="ismemberofmditabgroup"></a>CMDIFrameWndEx::IsMemberOfMDITabGroup  
 Détermine si la fenêtre à onglets spécifiée se trouve dans la liste des fenêtres qui se trouvent dans des groupes avec onglet MDI.  
...
### <a name="return-value"></a>Valeur de retour  
 `TRUE`Si la fenêtre à onglets spécifiée est dans la liste des fenêtres à onglets qui forment des groupes avec onglet MDI. Dans le cas contraire `FALSE`.  
...
##  <a name="a-nameismenubaravailablea--cmdiframewndexismenubaravailable"></a><a name="ismenubaravailable"></a>CMDIFrameWndEx::IsMenuBarAvailable  
 Détermine si la fenêtre frame comporte une barre de menus.  
...
##  <a name="a-nameloadmdistatea--cmdiframewndexloadmdistate"></a><a name="loadmdistate"></a>CMDIFrameWndEx::LoadMDIState  
 Charge la disposition des groupes d’onglets MDI spécifiée et la liste des documents précédemment ouverts.  
...
-   Appelez [CMDIFrameWndEx::LoadMDIState](#loadmdistate) lorsque le frame principal est créé. Pour que cet appel est recommandé avant le frame principal s’affiche pour la première fois. Ajouter `CWinAppEx::EnableLoadWindowPlacement` `(FALSE);` avant `pMainFrame->LoadFrame (IDR_MAINFRAME);.` ajouter `CBCGPWorkspace::ReloadWindowPlacement` `(pMainFrame);` après l’appel à `LoadMDIState` pour afficher le frame principal à la position qui a été stockée dans le Registre.  
  
-   Substituer `GetDocumentName` dans le `CMDIChildWndEx`-classe dérivée si votre application affiche des documents qui ne sont pas stockées sous forme de fichiers. La chaîne retournée sera enregistrée dans le Registre sous l’identificateur de document. L’implémentation de base de [CMDIChildWndEx::GetDocumentName](../../mfc/reference/cmdichildwndex-class.md#getdocumentname) renvoie une valeur obtenue à partir de [CDocument::GetPathName](../../mfc/reference/cdocument-class.md#getpathname).  
  
-   Substituer [CMDIFrameWndEx::CreateDocumentWindow](#createdocumentwindow) pour créer des documents correctement lorsqu’elles sont chargées à partir du Registre. Le premier paramètre est la chaîne qui `GetDocumentName` retournée.  
  
### <a name="example"></a>Exemple  
 L’exemple suivant montre comment `LoadMDIState` est utilisée dans les [exemple VisualStudioDemo : Application MFC de Visual Studio](../../visual-cpp-samples.md).  
...
##  <a name="a-namemditabmovetonextgroupa--cmdiframewndexmditabmovetonextgroup"></a><a name="mditabmovetonextgroup"></a>CMDIFrameWndEx::MDITabMoveToNextGroup  
 Déplace l’onglet actif à partir de la fenêtre à onglets active pour le groupe d’onglets suivant ou précédent.  
...
##  <a name="a-namemditabnewgroupa--cmdiframewndexmditabnewgroup"></a><a name="mditabnewgroup"></a>CMDIFrameWndEx::MDITabNewGroup  
 Crée un nouveau groupe d’onglets qui a une seule fenêtre.  
...
### <a name="parameters"></a>Paramètres  
 [in] `bVert`  
 Spécifie le nouveau groupe Alignement. Si `TRUE`, le nouveau groupe est aligné verticalement. Si `FALSE`, le nouveau groupe est aligné horizontalement.  
  
### <a name="remarks"></a>Notes  
 Cette fonction permet de créer un nouveau onglets fenêtre (nouveau groupe avec onglets) et lui ajouter le premier onglet.  
  
### <a name="example"></a>Exemple  
 L’exemple suivant montre comment `MDITabNewGroup` est utilisée dans les [exemple VisualStudioDemo : Application MFC de Visual Studio](../../visual-cpp-samples.md).  
...
##  <a name="a-namembcancovertcontrolbartomdichilda--cmdiframewndexmbcancovertcontrolbartomdichild"></a><a name="m_bcancovertcontrolbartomdichild"></a>CMDIFrameWndEx::m_bCanCovertControlBarToMDIChild  
 Spécifie si les volets d’ancrage peuvent devenir des fenêtres enfants MDI.  
...
### <a name="example"></a>Exemple  
 L’exemple suivant montre comment `m_bCanCovertControlBarToMDIChild` est utilisée dans les [exemple VisualStudioDemo : Application MFC de Visual Studio](../../visual-cpp-samples.md).  
...
### <a name="remarks"></a>Remarques  
 ...
 Cet indicateur la valeur `FALSE` si vous souhaitez optimiser le rafraîchissement du dessin d’enfants MDI. Dans ce cas le framework appelle `SetRedraw (FALSE)` pour le frame principal lorsque l’application change l’onglet actif.  
  
 Cet indicateur peut provoquer des effets indésirables (tels que les applications d’arrière-plan qui sont visibles). Par conséquent, nous vous recommandons de modifier la valeur par défaut uniquement si vous rencontrez scintillement notable lors de l’activation d’onglet MDI.  
...
##  <a name="a-namenegotiateborderspacea--cmdiframewndexnegotiateborderspace"></a><a name="negotiateborderspace"></a>CMDIFrameWndEx::NegotiateBorderSpace  
 Lors de l’activation sur place OLE, négocie espace bordure dans une fenêtre frame.  
...
### <a name="parameters"></a>Paramètres  
 [in] `nBorderCmd`  
 Contient l’une des valeurs suivantes de l’énumération `CFrameWnd::BorderCmd`:  
...
- `borderSet` = 3  
 ...
 [in, out] `lpRectBorder`  
 Pointeur vers un [Structure RECT](../../mfc/reference/rect-structure1.md) ou [CRect Class](../../atl-mfc-shared/reference/crect-class.md) objet qui spécifie les coordonnées de la bordure.  
...
##  <a name="a-nameonclosedockingpanea--cmdiframewndexonclosedockingpane"></a><a name="onclosedockingpane"></a>CMDIFrameWndEx::OnCloseDockingPane  
 Appelé par l’infrastructure lorsque l’utilisateur clique sur le **fermer** bouton dans un volet Ancrable.  
...
### <a name="return-value"></a>Valeur de retour  
 `TRUE`Si le volet d’accueil peut être fermé. Sinon, `FALSE`.  
  
### <a name="remarks"></a>Remarques  
 Substituez cette méthode pour gérer le masquage des volets d’ancrage. Retourner `FALSE` si vous souhaitez empêcher un volet d’ancrage soient masqués.  
...
##  <a name="a-nameoncloseminiframea--cmdiframewndexoncloseminiframe"></a><a name="oncloseminiframe"></a>CMDIFrameWndEx::OnCloseMiniFrame  
 Appelé par l’infrastructure lorsque l’utilisateur clique sur le **fermer** bouton sur une fenêtre mini-frame flottante.  
...
### <a name="remarks"></a>Notes  
 Substituez cette méthode pour gérer le masquage de mini-frame fenêtres flottantes. Retourner `FALSE` si vous souhaitez empêcher une fenêtre mini-frame flottante soient masqués.  
...
### <a name="remarks"></a>Remarques  
 Substituez cette méthode si vous souhaitez traiter les notifications de [CMFCPopupMenu classe](../../mfc/reference/cmfcpopupmenu-class.md) les objets qui appartiennent à la fenêtre frame MDI lorsque ces objets traitement `WM_DESTROY` messages.  
  
##  <a name="a-nameoncmdmsga--cmdiframewndexoncmdmsg"></a><a name="oncmdmsg"></a>CMDIFrameWndEx::OnCmdMsg  
 Appelé par l’infrastructure pour router et distribuer des messages de commande et mettre à jour les objets d’interface utilisateur de commande.  
...
### <a name="parameters"></a>Paramètres  
 ...
 [in] `nCode`  
 Identifie le code de notification de commande. Consultez la page [CCmdTarget::OnCmdMsg](../../mfc/reference/ccmdtarget-class.md#oncmdmsg) pour plus d’informations sur les valeurs de `nCode`.  
  
 [in] `pExtra`  
 Utilisé en fonction de la valeur de `nCode`. Consultez la page [CCmdTarget::OnCmdMsg](../../mfc/reference/ccmdtarget-class.md#oncmdmsg) pour plus d’informations sur `pExtra`.  
  
 [in, out] `pHandlerInfo`  
 En règle générale, ce paramètre doit être `NULL`. Si ce n’est pas `NULL`, `OnCmdMsg` renseigne la `pTarget` et `pmf` les membres de le `pHandlerInfo` structure au lieu de la distribution de la commande.  
...
### <a name="remarks"></a>Remarques  
 Substituez cette méthode si vous souhaitez personnaliser le rendu de l’image pour les éléments de menu qui appartiennent à la barre de menus détenue par le `CMDIFrameWndEx`-objet dérivé. L'implémentation par défaut n'exécute aucune opération.  
...
##  <a name="a-nameonerasemdiclientbackgrounda--cmdiframewndexonerasemdiclientbackground"></a><a name="onerasemdiclientbackground"></a>CMDIFrameWndEx::OnEraseMDIClientBackground  
 Appelé par l’infrastructure lorsque l’interface MDI frame processus de fenêtre un `WM_ERASEBKGND` message.  
...
##  <a name="a-nameonshowcustomizepanea--cmdiframewndexonshowcustomizepane"></a><a name="onshowcustomizepane"></a>CMDIFrameWndEx::OnShowCustomizePane  
 Appelé par l’infrastructure lorsqu’un volet Personnalisation rapide est activé.  
...
### <a name="parameters"></a>Paramètres  
 [in] `pMenuPane`  
 Pointeur vers le volet Personnalisation rapide.  
...
### <a name="remarks"></a>Notes  
 Le volet Personnalisation rapide est un menu qui s’ouvre lorsque l’utilisateur clique sur **personnaliser** une barre d’outils.  
...
##  <a name="a-nameonshowmditabcontextmenua--cmdiframewndexonshowmditabcontextmenu"></a><a name="onshowmditabcontextmenu"></a>CMDIFrameWndEx::OnShowMDITabContextMenu  
 Appelé par l’infrastructure avant un menu contextuel s’affiche sur un des onglets. Valide pour les groupes avec onglet MDI uniquement.  
...
- `BCGP_MDI_CAN_BE_DOCKED`-utiliser un document à onglets état ancré (pertinent pour les documents avec onglet uniquement).  
  
 [in] `bTabDrop`  
 `TRUE`Pour afficher le menu suite à faire glisser l’onglet vers un autre groupe d’onglets. `FALSE`Pour afficher le menu comme menu contextuel de l’onglet actuellement actif.  
  
### <a name="return-value"></a>Valeur de retour  
 Substituez cette méthode dans un [CBCGPMDIFrameWnd](../../mfc/reference/cmdiframewndex-class.md)-classe dérivée.  
  
### <a name="remarks"></a>Remarques  
 Si vous ne traitez pas `OnShowMDITabContextMenu`, le menu contextuel ne s’affichera pas. Cette fonction est générée par le **Assistant Application MFC** lorsque vous activez la fonctionnalité des groupes avec onglet MDI.  
  
### <a name="example"></a>Exemple  
 L’exemple suivant montre comment `OnShowMDITabContextMenu` est utilisée dans les [exemple VisualStudioDemo : Application MFC de Visual Studio](../../visual-cpp-samples.md).  
...
### <a name="return-value"></a>Valeur de retour  
 `TRUE`Si l’état des volets change en appelant cette méthode, `FALSE` si les volets sont déjà dans l’état spécifié par `bShow`. Par exemple, si les volets sont masqués et `bShow` est `FALSE`, la valeur de retour est `FALSE`.  
...
### <a name="remarks"></a>Remarques  
 Substituez cette méthode si vous souhaitez mettre en œuvre un traitement spécial lors de l’activation du menu contextuel. Par exemple, si vous souhaitez modifier des éléments de menu standard pour les boutons de menu de couleur, définir des barres détachable et ainsi de suite.  
...
### <a name="parameters"></a>Paramètres  
 ...
 [in] `pBar`  
 Pointeur vers la barre détachables.  
  
### <a name="return-value"></a>Valeur de retour  
 `TRUE`pour permettre le menu contextuel avec la barre détachable fassent activer ; dans le cas contraire `FALSE`. La valeur par défaut est `TRUE`.  
  
### <a name="remarks"></a>Notes  
 Remplacez cette fonction lorsque vous souhaitez implémenter une installation spéciale pour la barre détachables. L'implémentation par défaut n'exécute aucune opération.  
...
### <a name="parameters"></a>Paramètres  
 ...
 [in] `nSensitivity`  
 Le rectangle de la fenêtre de chaque volet checked est agrandi dans toutes les directions de cette valeur.  
 ...
 [out] `dwAlignment`  
 Si un volet est trouvé, ce paramètre spécifie le côté du volet est le plus proche du point spécifié.  
  
### <a name="return-value"></a>Valeur de retour  
 Un pointeur vers un volet d’ancrage, ou `NULL` si aucun contrôle ne contient le point spécifié par `point`.  
  
### <a name="remarks"></a>Notes  
 L’appel est redirigé vers le [CDockingManager classe](../../mfc/reference/cdockingmanager-class.md). Consultez la page [CDockingManager::ControlBarFromPoint](../../mfc/reference/cdockingmanager-class.md#panefrompoint) pour plus d’informations.  
  
##  <a name="a-namerecalclayouta--cmdiframewndexrecalclayout"></a><a name="recalclayout"></a>CMDIFrameWndEx::RecalcLayout  
 Appelée par l’infrastructure pour recalculer la disposition de la fenêtre frame.  
...
##  <a name="a-nameremovepanefromdockmanagera--cmdiframewndexremovepanefromdockmanager"></a><a name="removepanefromdockmanager"></a>CMDIFrameWndEx::RemovePaneFromDockManager  
 Annule l’inscription d’un volet et elle supprime le Gestionnaire d’ancrage.  
...
### <a name="parameters"></a>Paramètres  
 ...
 [in] `bAdjustLayout`  
 `TRUE`Pour ajuster la disposition d’ancrage immédiatement. Si `FALSE`, l’ajustement se produit uniquement lorsqu’un événement de renouvellement se produit pour d’autres raisons (l’utilisateur redimensionne la fenêtre, déplace le frame principal, etc.).  
...
### <a name="remarks"></a>Remarques  
 Vous devez enregistrer chaque volet avec le Gestionnaire d’ancrage à participer à la disposition d’ancrage. Utilisez [CMDIFrameWndEx::AddPane](#addpane) ou [CMDIFrameWndEx::InsertPane](#insertpane) pour inscrire les volets.  
...
##  <a name="a-namesavemdistatea--cmdiframewndexsavemdistate"></a><a name="savemdistate"></a>CMDIFrameWndEx::SaveMDIState  
 Enregistre la disposition actuelle des groupes d’onglets MDI et la liste des documents précédemment ouverts.  
...
-   Substituer [CMDIFrameWndEx::CreateDocumentWindow](#createdocumentwindow) pour créer des documents correctement lorsqu’elles sont chargées à partir du Registre. Le paramètre `CreateDocumentWindow` est la chaîne qui `GetDocumentName` renvoyée précédemment.  
  
### <a name="example"></a>Exemple  
 L’exemple suivant montre comment `SaveMDIState` est utilisée dans les [exemple VisualStudioDemo : Application MFC de Visual Studio](../../visual-cpp-samples.md).  
...
##  <a name="a-namesetuptoolbarmenua--cmdiframewndexsetuptoolbarmenu"></a><a name="setuptoolbarmenu"></a>CMDIFrameWndEx::SetupToolbarMenu  
 Modifie un objet de barre d’outils en remplaçant les éléments factices avec des éléments définis par l’utilisateur.  
...
### <a name="parameters"></a>Paramètres  
 ...
 [in] `bActivate`  
 `TRUE`Pour afficher le volet doit comme actif. `FALSE`Pour afficher le volet comme inactive.  
  
### <a name="remarks"></a>Notes  
 Appelez cette méthode pour afficher ou masquer le volet. N’utilisez pas `ShowWindow` pour volets d’ancrage.  
  
### <a name="example"></a>Exemple  
 L’exemple suivant montre comment `ShowPane` est utilisée dans les [exemple VisualStudioDemo : Application MFC de Visual Studio](../../visual-cpp-samples.md).  
...
### <a name="example"></a>Exemple  
 L’exemple suivant montre comment `ShowWindowsDialog` est utilisée dans les [exemple VisualStudioDemo : Application MFC de Visual Studio](../../visual-cpp-samples.md).  
...
##  <a name="a-nametabbeddocumenttocontrolbara--cmdiframewndextabbeddocumenttocontrolbar"></a><a name="tabbeddocumenttocontrolbar"></a>CMDIFrameWndEx::TabbedDocumentToControlBar  
 Convertit le document à onglets spécifié à un volet d’ancrage.  
...
### <a name="example"></a>Exemple  
 L’exemple suivant montre comment `TabbedDocumentToControlBar` est utilisée dans les [exemple VisualStudioDemo : Application MFC de Visual Studio](../../visual-cpp-samples.md).  
  
 [!code-cpp[NVC_MFC_VisualStudioDemo n °&19;](../../mfc/codesnippet/cpp/cmdiframewndex-class_17.cpp)]  
  
##  <a name="a-nameupdatecaptiona--cmdiframewndexupdatecaption"></a><a name="updatecaption"></a>CMDIFrameWndEx::UpdateCaption  
 Appelé par l’infrastructure pour mettre à jour la légende de la fenêtre frame.  
