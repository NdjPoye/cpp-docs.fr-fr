...
|Option|Description|  
|------------|-----------------|  
|**Registre**|La bibliothèque de types est enregistrée dans le système. Bibliothèques de types inscrits sont répertoriés dans **bibliothèques de types disponibles**.|  
