...
## <a name="remarks"></a>Notes  
 ...
 Vous pouvez contrôler l’épaisseur de la faire glisser le rectangle à l’aide de [AFX_GLOBAL_DATA::m_nDragFrameThicknessFloat]--brokenlink--(afx-global-data-structure.md#m_ndragframethicknessfloat) et [AFX_GLOBAL_DATA::m_nDragFrameThicknessDock ](afx-global-data-structure.md#m_ndragframethicknessdock).  
