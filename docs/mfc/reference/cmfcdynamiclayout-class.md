...
##  <a name="movesettings_structure"></a>Structure de CMFCDynamicLayout::MoveSettings  
...
##  <a name="sizesettings_structure"></a>Structure de CMFCDynamicLayout::SizeSettings  
