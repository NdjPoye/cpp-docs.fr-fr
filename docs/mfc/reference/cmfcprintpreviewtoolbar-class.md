...
helpviewer_keywords: 
  ...
  - "CMFCPrintPreviewToolBar class, destructeur"
...
|-|-|  
|Nom|Description|  
|`CMFCPrintPreviewToolBar::GetThisClass`|Utilisé par l'infrastructure pour obtenir un pointeur vers l'objet de [CRuntimeClass](../../mfc/reference/cruntimeclass-structure.md) associé à ce type de classe.|  
