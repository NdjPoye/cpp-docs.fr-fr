...
-   [Exemples](../mfc/common-control-sample-list.md)  
 ...
 Pour plus d’informations sur les contrôles communs Windows dans le [!INCLUDE[winSDK](../atl/includes/winsdk_md.md)], consultez [Contrôles communs](http://msdn.microsoft.com/library/windows/desktop/bb775493).  
