---
title: "Comment&#160;: personnaliser le bouton Application | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "bouton Application, personnaliser"
...
When you click the Application button, a menu of commands is displayed.  Typically, the menu contains file\-related commands such as **Open**, **Save**, **Print**, and **Exit**.  
 ...
 ![Bouton Application de ruban MFC](../mfc/media/application_button.png "Application\_Button")  
...
|---------------|----------------|  
|**Boutons**|Contains the collection of up to three buttons that appear in the bottom\-right corner of the Application menu.|  
...
|**Touches**|Specifies the string that is displayed when key\-tip navigation is enabled.  Key\-tip navigation is enabled when you press ALT.|  
...
|**Utilisez**|Enables or disables the Recent List panel.  The Recent List panel appears on the Application menu.|  
|**Largeur**|Specifies the width in pixels of the Recent List panel.|  
