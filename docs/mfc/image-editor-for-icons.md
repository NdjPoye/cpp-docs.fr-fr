...
-   [Modifier des ressources graphiques](../mfc/editing-graphical-resources-image-editor-for-icons.md)  
  
-   [Utiliser des couleurs](../mfc/working-with-color-image-editor-for-icons.md)  
  
-   [Utiliser des icônes et des curseurs : ressources d'images pour périphériques d'affichage](../mfc/icons-and-cursors-image-resources-for-display-devices-image-editor-for-icons.md)  
  
-   [Utiliser des touches accélérateur pour les commandes de l'Éditeur d'images](../mfc/accelerator-keys-image-editor-for-icons.md)  
