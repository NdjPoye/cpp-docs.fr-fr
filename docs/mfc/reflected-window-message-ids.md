---
title: "ID des messages de fen&#234;tre r&#233;fl&#233;chis | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
helpviewer_keywords: 
  ...
  - "OCM_VSCROLL (message)"
  - "messages réfléchis"
  - "messages réfléchis, ID des messages de fenêtre"
...
Un moyen rapide de créer un contrôle ActiveX, ou un autre contrôle spécialisé, est de sous\-classer une fenêtre.  Pour plus d'informations, consultez l'[Contrôles ActiveX MFC : Sous\-classement d'un contrôle Windows](../mfc/mfc-activex-controls-subclassing-a-windows-control.md).  
  
 Pour empêcher le conteneur du contrôle de recevoir les messages de la fenêtre envoyés par un contrôle Windows sous\-classé, [COleControl](../mfc/reference/colecontrol-class.md) crée une fenêtre « reflector » pour désactiver certains messages de la fenêtre et les renvoyer au contrôle.  Le contrôle, dans la procédure d'affichage, peut ensuite traiter ces messages réfléchis en utilisant les actions appropriées pour un contrôle ActiveX.  
...
> [!NOTE]
>  Si le contrôle est sur un système Win32, il y a plusieurs types de messages **WM\_CTLCOLOR\*** qu'il peut recevoir.  Pour plus d'informations, consultez **WM\_CTLCOLORBTN**, **WM\_CTLCOLORDLG**, **WM\_CTLCOLOREDIT**, **WM\_CTLCOLORLISTBOX**, **WM\_CTLCOLORMSGBOX**, **WM\_CTLCOLORSCROLLBAR**, **WM\_CTLCOLORSTATIC**.  
