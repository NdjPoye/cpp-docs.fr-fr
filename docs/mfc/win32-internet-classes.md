...
helpviewer_keywords: 
  - "classes Internet"
  - "Win32 (C++), classes Internet"
  - "API Windows (C++), classes Internet"
...
---
# Classes Internet Win32
[!INCLUDE[vs2017banner](../assembler/inline/includes/vs2017banner.md)]

MFC encapsule la technologie Internet \(WinInet\) et ActiveX Win32 pour faciliter la programmation Internet.  
 ...
 Cette classe et ses classes dérivées permettent l'accès aux fichiers sur les systèmes distants qui utilisent les protocoles Internet.  
  
 [CHttpConnection](../mfc/reference/chttpconnection-class.md)  
 Gère votre connexion à un serveur HTTP.  
  
 [CHttpFile](../mfc/reference/chttpfile-class.md)  
 Fournit les fonctionnalités permettant de trouver et de lire des fichiers sur un serveur HTTP.  
 ...
 Effectue les recherches de fichiers en local et sur Internet.  
