...
La bibliothèque ATL (Active Template Library) est un ensemble de classes C++ basées sur des modèles qui facilitent la création des objets COM petits et rapides. L’Assistant Projet ATL crée un projet avec les structures de contenir des objets COM.  
  
## <a name="overview"></a>Vue d'ensemble  
 Cette page décrit actuel [paramètres d’application pour le projet ATL](../../atl/reference/application-settings-atl-project-wizard.md) vous créez. Par défaut, le projet possède les paramètres suivants :  
...
-   Avec attributs Spécifie que votre projet utilise des attributs.  
 ...
 Pour plus d’informations sur les paramètres de projet par défaut, y compris le choix du jeu de caractères et les liaisons par défaut, consultez [Configurations des projets ATL par défaut](../../atl/reference/default-atl-project-configurations.md).  
