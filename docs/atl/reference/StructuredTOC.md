...
# [ATL, assistants et boîtes de dialogue](atl-wizards-and-dialog-boxes.md)
...
### [Configurations des projets ATL par défaut](default-atl-project-configurations.md)
### [Prise en charge MFC dans les projets ATL](mfc-support-in-atl-projects.md)
### [Prise en charge COM+ 1.0 dans les projets ATL](com-plus-1-0-support-in-atl-projects.md)
...
### [Assignation de l'attribut noncreatable à un objet ATL](making-an-atl-object-noncreatable.md)
## [Ajout d'un objet simple ATL](adding-an-atl-simple-object.md)
### [Objet simple ATL (Assistant)](atl-simple-object-wizard.md)
#### [Options, Assistant Objet simple ATL](options-atl-simple-object-wizard.md)
...
#### [Options, Assistant Page de propriétés ATL](options-atl-property-page-wizard.md)
#### [Chaînes, Assistant Page de propriétés ATL](strings-atl-property-page-wizard.md)
## [Ajout d'un fournisseur ATL OLE DB](adding-an-atl-ole-db-provider.md)
### [Fournisseur OLE DB ATL (Assistant)](atl-ole-db-provider-wizard.md)
## [Ajout d'un consommateur OLE DB ATL](adding-an-atl-ole-db-consumer.md)
### [Assistant Consommateur OLE DB ATL](atl-ole-db-consumer-wizard.md)
## [Adding an ATL Dialog Box](adding-an-atl-dialog-box.md)
### [Dialogue ATL (Assistant)](atl-dialog-wizard.md)
## [Ajout d'un contrôle ATL](adding-an-atl-control.md)
### [Assistant Contrôle ATL](atl-control-wizard.md)
#### [Options, Assistant contrôle ATL](options-atl-control-wizard.md)
#### [Interfaces, Assistant contrôle ATL](interfaces-atl-control-wizard.md)
#### [Apparence, Assistant contrôle ATL](appearance-atl-control-wizard.md)
#### [Propriétés stock, Assistant Contrôle ATL](stock-properties-atl-control-wizard.md)
## [Ajout d'un composant ATL COM+ 1.0](adding-an-atl-com-plus-1-0-component.md)
### [Composant ATL COM+ 1.0 (Assistant)](atl-com-plus-1-0-component-wizard.md)
#### [COM+ 1.0, Assistant Composant COM+ 1.0 ATL](com-plus-1-0-atl-com-plus-1-0-component-wizard.md)
## [Ajout d'un composant Active Server Page ATL](adding-an-atl-active-server-page-component.md)
### [Composant Active Server Page ATL (Assistant)](atl-active-server-page-component-wizard.md)
### [Options, Assistant Composant ASP ATL](options-atl-active-server-page-component-wizard.md)
### [ASP, Assistant Composant ASP ATL](asp-atl-active-server-page-component-wizard.md)
