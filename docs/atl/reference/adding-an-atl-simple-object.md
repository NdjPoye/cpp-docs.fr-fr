...
3.  Dans le [ajouter une classe](../../ide/add-class-dialog-box.md) boîte de dialogue, dans le volet Modèles, cliquez sur **objet Simple ATL**, puis cliquez sur **Open** pour afficher les [Assistant objet Simple ATL](../../atl/reference/atl-simple-object-wizard.md).  
