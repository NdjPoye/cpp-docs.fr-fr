...
### <a name="remarks"></a>Notes  
 Styles d’être ajoutés ou supprimés peuvent être combinées à l’aide de l’OR au niveau du bit (&#124;) (opérateur). Consultez le [CreateWindow](http://msdn.microsoft.com/library/windows/desktop/ms632679) fonction dans les Windows SDKfor d’informations sur les styles de fenêtres disponibles.  
...
### <a name="remarks"></a>Notes  
 Styles d’être ajoutés ou supprimés peuvent être combinées à l’aide de l’OR au niveau du bit (&#124;) (opérateur). Consultez le [CreateWindowEx](http://msdn.microsoft.com/library/windows/desktop/ms632680) fonction dans les Windows SDKfor d’informations sur les styles étendus disponibles.  
