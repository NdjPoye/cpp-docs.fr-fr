...
Ces classes fournissent des méthodes pour gérer les fichiers, les fichiers temporaires, et des fichiers mappés en mémoire.  
  
-   [CAtlFile](../atl/reference/catlfile-class.md) cette classe fournit un wrapper mince autour de l'API de gestion de fichiers windows.  
