...
Opérateur de conversion de type entre `auto_gcroot` et les types compatibles.  
...
## Valeur de retour  
 Le `auto_gcroot` actuel converti en `auto_gcroot<_other_type>`.  
