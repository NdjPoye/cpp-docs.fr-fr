...
## <a name="using-new-visual-c-features"></a>À l’aide des nouvelles fonctionnalités de Visual C++  
 ...
 Si vous avez utilisé des Extensions managées pour C++, vous pouvez convertir votre code pour utiliser la nouvelle syntaxe. Pour obtenir un résumé des différences syntaxiques, consultez le [(NOTINBUILD) des Extensions managées pour C++ Syntax Upgrade Checklist](http://msdn.microsoft.com/en-us/edbded88-7ef3-4757-bd9d-b8f48ac2aada). Pour plus d’informations sur la conversion d’Extensions managées pour C++, consultez [C + c++ / CLI Migration Primer](../dotnet/cpp-cli-migration-primer.md).  
