...
### [Comment : créer des projets vides CLR](how-to-create-clr-empty-projects.md)
### [Comment : créer des applications console CLR (C++/CLI)](how-to-create-clr-console-applications-cpp-cli.md)
### [Comment : utiliser des références de suivi dans C++/CLI](how-to-use-tracking-references-in-cpp-cli.md)
### [Comment : utiliser des tableaux dans C++/CLI](how-to-use-arrays-in-cpp-cli.md)
### [Comment : définir et consommer des Classes et Structs (C++-CLI)](how-to-define-and-consume-classes-and-structs-cpp-cli.md)
...
### [Comment : définir et utiliser des délégués (C++/CLI)](how-to-define-and-use-delegates-cpp-cli.md)
### [Comment : définir et consommer des énumérateurs dans C++/CLI](how-to-define-and-consume-enums-in-cpp-cli.md)
### [Comment : utiliser des événements dans C++/CLI](how-to-use-events-in-cpp-cli.md)
### [Comment : définir un constructeur d'interface statique (C++/CLI)](how-to-define-an-interface-static-constructor-cpp-cli.md)
### [Comment : déclarer des spécificateurs de substitution dans les compilations natives (C++/CLI)](how-to-declare-override-specifiers-in-native-compilations-cpp-cli.md)
### [Comment : utiliser des propriétés dans C++/CLI](how-to-use-properties-in-cpp-cli.md)
### [Comment : utiliser safe_cast dans C++/CLI](how-to-use-safe-cast-in-cpp-cli.md)
...
#### [Comment : effectuer une migration vers /clr](how-to-migrate-to-clr.md)
#### [Comment : compiler du code MFC et ATL à l'aide de /clr](how-to-compile-mfc-and-atl-code-by-using-clr.md)
...
#### [Comment : créer une application partiellement approuvée en supprimant la dépendance de la DLL de la bibliothèque CRT](create-a-partially-trusted-application.md)
...
##### [Comment : créer le contrôle utilisateur et l'héberger dans une boîte de dialogue](how-to-create-the-user-control-and-host-in-a-dialog-box.md)
##### [Comment : établir la liaison des données DDX/DDV avec Windows Forms](how-to-do-ddx-ddv-data-binding-with-windows-forms.md)
##### [Comment : recevoir des événements Windows Forms de classes C++ natives](how-to-sink-windows-forms-events-from-native-cpp-classes.md)
...
##### [Comment : créer le contrôle utilisateur et héberger l'affichage MDI](how-to-create-the-user-control-and-host-mdi-view.md)
##### [Comment : ajouter le routage des commandes au contrôle Windows Forms](how-to-add-command-routing-to-the-windows-forms-control.md)
##### [Comment : appeler des propriétés et des méthodes du contrôle Windows Forms](how-to-call-properties-and-methods-of-the-windows-forms-control.md)
...
##### [Comment : appeler des DLL natives à partir du code managé à l'aide de PInvoke](how-to-call-native-dlls-from-managed-code-using-pinvoke.md)
##### [Comment : marshaler des chaînes à l'aide de PInvoke](how-to-marshal-strings-using-pinvoke.md)
##### [Comment : marshaler des structures à l'aide de PInvoke](how-to-marshal-structures-using-pinvoke.md)
##### [Comment : marshaler des tableaux à l'aide de PInvoke](how-to-marshal-arrays-using-pinvoke.md)
##### [Comment : marshaler des pointeurs fonction à l'aide de PInvoke](how-to-marshal-function-pointers-using-pinvoke.md)
##### [Comment : marshaler des pointeurs incorporés à l'aide de PInvoke](how-to-marshal-embedded-pointers-using-pinvoke.md)
#### [Utilisation de l'interopérabilité C++ (PInvoke implicite)](using-cpp-interop-implicit-pinvoke.md)
##### [Comment : marshaler des chaînes ANSI à l'aide de l'interopérabilité C++](how-to-marshal-ansi-strings-using-cpp-interop.md)
##### [Comment : marshaler des chaînes Unicode à l'aide de l'interopérabilité C++](how-to-marshal-unicode-strings-using-cpp-interop.md)
##### [Comment : marshaler des chaînes COM à l'aide de l'interopérabilité C++](how-to-marshal-com-strings-using-cpp-interop.md)
##### [Comment : marshaler des structures à l'aide de l'interopérabilité C++](how-to-marshal-structures-using-cpp-interop.md)
##### [Comment : marshaler des tableaux à l'aide de l'interopérabilité C++](how-to-marshal-arrays-using-cpp-interop.md)
##### [Comment : marshaler des rappels et des délégués à l'aide de l'interopérabilité C++](how-to-marshal-callbacks-and-delegates-by-using-cpp-interop.md)
##### [Comment : marshaler des pointeurs incorporés à l'aide de l'interopérabilité C++](how-to-marshal-embedded-pointers-using-cpp-interop.md)
##### [Comment : étendre la bibliothèque de marshaling](how-to-extend-the-marshaling-library.md)
##### [Comment : accéder aux caractères d'un System::String](how-to-access-characters-in-a-system-string.md)
##### [Comment : convertir la chaîne char * en tableau System::Byte](how-to-convert-char-star-string-to-system-byte-array.md)
##### [Comment : convertir System::String en wchar_t * ou char*](how-to-convert-system-string-to-wchar-t-star-or-char-star.md)
##### [Comment : convertir System::String en chaîne standard](how-to-convert-system-string-to-standard-string.md)
##### [Comment : convertir une chaîne standard en System::String](how-to-convert-standard-string-to-system-string.md)
##### [Comment : obtenir un pointeur vers un tableau d'octets](how-to-obtain-a-pointer-to-byte-array.md)
##### [Comment : charger des ressources non managées dans un tableau d'octets](how-to-load-unmanaged-resources-into-a-byte-array.md)
##### [Comment : modifier la classe de référence dans une fonction native](how-to-modify-reference-class-in-a-native-function.md)
##### [Comment : déterminer si une image est native ou CLR](how-to-determine-if-an-image-is-native-or-clr.md)
##### [Comment : ajouter une DLL native au Global Assembly Cache](how-to-add-native-dll-to-global-assembly-cache.md)
##### [Comment : stocker une référence à un type valeur dans un type natif](how-to-hold-reference-to-value-type-in-native-type.md)
##### [Comment : stocker la référence d'un objet dans une mémoire non managée](how-to-hold-object-reference-in-unmanaged-memory.md)
##### [Comment : détecter une compilation /clr](how-to-detect-clr-compilation.md)
##### [Comment : procéder à une conversion entre System::Guid et _GUID](how-to-convert-between-system-guid-and-guid.md)
##### [Comment : spécifier un paramètre Out](how-to-specify-an-out-parameter.md)
##### [Comment : utiliser un type natif dans une compilation /clr](how-to-use-a-native-type-in-a-clr-compilation.md)
##### [Comment : déclarer des handles dans les types natifs](how-to-declare-handles-in-native-types.md)
##### [Comment : inclure une classe native dans un wrapper pour une utilisation par C#](how-to-wrap-native-class-for-use-by-csharp.md)
...
### [Types managés (C++/CL)](managed-types-cpp-cl.md)
...
### [Comment : effectuer une migration vers /clr:pure (C++/CLI)](how-to-migrate-to-clr-pure-cpp-cli.md)
### [Comment : créer des projets C++ vérifiables (C++/CLI)](how-to-create-verifiable-cpp-projects-cpp-cli.md)
### [Comment : effectuer une migration vers /clr:safe (C++/CLI)](how-to-migrate-to-clr-safe-cpp-cli.md)
...
### [Comment : établir des correspondances simples à l'aide d'expressions régulières (C++/CLI)](how-to-use-regular-expressions-for-simple-matching-cpp-cli.md)
### [Comment : extraire des champs de données à l'aide d'expressions régulières (C++/CLI)](how-to-use-regular-expressions-to-extract-data-fields-cpp-cli.md)
### [Comment : réorganiser des données à l'aide d'expressions régulières (C++/CLI)](how-to-use-regular-expressions-to-rearrange-data-cpp-cli.md)
### [Comment : utiliser des expressions régulières pour les recherches et remplacements (C++/CLI)](how-to-use-regular-expressions-to-search-and-replace-cpp-cli.md)
### [Comment : valider la mise en forme de données à l'aide d'expressions régulières (C++/CLI)](how-to-use-regular-expressions-to-validate-data-formatting-cpp-cli.md)
### [Comment : analyser des chaînes à l'aide de la méthode Split (C++/CLI)](how-to-parse-strings-using-the-split-method-cpp-cli.md)
### [Comment : analyser des chaînes à l'aide d'expressions régulières (C++/CLI)](how-to-parse-strings-using-regular-expressions-cpp-cli.md)
## [Gestion de fichiers et E/S (C++/CLI)](file-handling-and-i-o-cpp-cli.md)
### [Comment : énumérer les fichiers d'un répertoire (C++/CLI)](how-to-enumerate-files-in-a-directory-cpp-cli.md)
### [Comment : surveiller les modifications de système de fichiers (C++/CLI)](how-to-monitor-file-system-changes-cpp-cli.md)
### [Comment : lire un fichier binaire (C++/CLI)](how-to-read-a-binary-file-cpp-cli.md)
### [Comment : lire un fichier texte (C++/CLI)](how-to-read-a-text-file-cpp-cli.md)
### [Comment : récupérer les informations d'un fichier (C++/CLI)](how-to-retrieve-file-information-cpp-cli.md)
### [Comment : écrire un fichier binaire (C++/CLI)](how-to-write-a-binary-file-cpp-cli.md)
### [Comment : écrire un fichier texte (C++/CLI)](how-to-write-a-text-file-cpp-cli.md)
## [Opérations graphiques (C++/CLI)](graphics-operations-cpp-cli.md)
### [Comment : convertir des fichiers au format image avec le .NET Framework](how-to-convert-image-file-formats-with-the-dotnet-framework.md)
### [Comment : afficher des images avec le .NET Framework](how-to-display-images-with-the-dotnet-framework.md)
### [Comment : dessiner des formes avec le .NET Framework](how-to-draw-shapes-with-the-dotnet-framework.md)
### [Comment : faire pivoter des images avec le .NET Framework](how-to-rotate-images-with-the-dotnet-framework.md)
## [Opérations Windows (C++/CLI)](windows-operations-cpp-cli.md)
### [Comment : déterminer si le processus d'arrêt a commencé (C++/CLI)](how-to-determine-if-shutdown-has-started-cpp-cli.md)
### [Comment : déterminer l'état interactif d'un utilisateur (C++/CLI)](how-to-determine-the-user-interactive-state-cpp-cli.md)
### [Comment : lire les données du Registre Windows (C++/CLI)](how-to-read-data-from-the-windows-registry-cpp-cli.md)
### [Comment : lire les compteurs de performance Windows (C++/CLI)](how-to-read-windows-performance-counters-cpp-cli.md)
### [Comment : récupérer du texte du Presse-papiers (C++/CLI)](how-to-retrieve-text-from-the-clipboard-cpp-cli.md)
### [Comment : récupérer la version du .NET Framework (C++/CLI)](how-to-retrieve-the-dotnet-framework-version-cpp-cli.md)
### [Comment : récupérer le nom d'utilisateur actuel (C++/CLI)](how-to-retrieve-the-current-username-cpp-cli.md)
### [Comment : récupérer le nom de l'ordinateur local (C++/CLI)](how-to-retrieve-the-local-machine-name-cpp-cli.md)
### [Comment : récupérer la version Windows (C++/CLI)](how-to-retrieve-the-windows-version-cpp-cli.md)
### [Comment : récupérer le temps écoulé depuis le démarrage (C++/CLI)](how-to-retrieve-time-elapsed-since-startup-cpp-cli.md)
### [Comment : stocker du texte dans le Presse-papiers (C++/CLI)](how-to-store-text-in-the-clipboard-cpp-cli.md)
### [Comment : écrire des données dans le Registre Windows (C++/CLI)](how-to-write-data-to-the-windows-registry-cpp-cli.md)
## [Accès aux données à l'aide d'ADO.NET (C++/CLI)](data-access-using-adonet-cpp-cli.md)
### [Comment : marshaler des chaînes ANSI pour ADO.NET (C++/CLI)](how-to-marshal-ansi-strings-for-adonet-cpp-cli.md)
### [Comment : marshaler des chaînes BSTR pour ADO.NET (C++/CLI)](how-to-marshal-bstr-strings-for-adonet-cpp-cli.md)
### [Comment : marshaler des chaînes Unicode pour ADO.NET (C++/CLI)](how-to-marshal-unicode-strings-for-adonet-cpp-cli.md)
### [Comment : marshaler un VARIANT pour ADO.NET (C++/CLI)](how-to-marshal-a-variant-for-adonet-cpp-cli.md)
### [Comment : marshaler un SAFEARRAY pour ADO.NET (C++/CLI)](how-to-marshal-a-safearray-for-adonet-cpp-cli.md)
## [Interopérabilité avec d'autres langages .NET (C++/CLI)](interoperability-with-other-dotnet-languages-cpp-cli.md)
### [Comment : implémenter les mots clés C# is et as (C++/CLI)](how-to-implement-is-and-as-csharp-keywords-cpp-cli.md)
### [Comment : implémenter le mot clé C# lock (C++/CLI)](how-to-implement-the-lock-csharp-keyword-cpp-cli.md)
### [Comment : consommer un indexeur C# (C++/CLI)](how-to-consume-a-csharp-indexer-cpp-cli.md)
...
### [Types managés et la fonction principale (C++/CLI)](managed-types-and-the-main-function-cpp-cli.md)
...
### [Comment : tester l'égalité (C++/CLI)](how-to-test-for-equality-cpp-cli.md)
### [Comment : diagnostiquer et résoudre les problèmes de compatibilité de l'assembly (C++/CLI)](how-to-diagnose-and-fix-assembly-compatibility-problems-cpp-cli.md)
## [Réflexion (C++/CLI)](reflection-cpp-cli.md)
### [Comment : implémenter une architecture de composants plug-in à l'aide de la réflexion (C++/CLI)](how-to-implement-a-plug-in-component-architecture-using-reflection-cpp-cli.md)
### [Comment : énumérer des types de données dans des assemblys à l'aide de réflexion (C++/CLI)](how-to-enumerate-data-types-in-assemblies-using-reflection-cpp-cli.md)
...
### [cliext, espace de noms](cliext-namespace.md)
### [STL/CLR, conteneurs](stl-clr-containers.md)
### [Spécifications pour les éléments de conteneur STL/CLR](requirements-for-stl-clr-container-elements.md)
### [Comment : convertir une collection .NET en conteneur STL/CLR](how-to-convert-from-a-dotnet-collection-to-a-stl-clr-container.md)
### [Comment : convertir un conteneur STL/CLR en collection .NET](how-to-convert-from-a-stl-clr-container-to-a-dotnet-collection.md)
### [Comment : exposer un conteneur STL/CLR d'un assembly](how-to-expose-an-stl-clr-container-from-an-assembly.md)
...
#### [Itération au sein d'une collection STL en utilisant for each](iterating-over-stl-collection-by-using-for-each.md)
#### [Comment : itérer au sein des tableaux avec for each](how-to-iterate-over-arrays-with-for-each.md)
#### [Comment : itérer au sein d'une collection générique en utilisant for each](how-to-iterate-over-a-generic-collection-with-for-each.md)
#### [Comment : itérer au sein d'une collection définie par l'utilisateur en utilisant for each](how-to-iterate-over-a-user-defined-collection-with-for-each.md)
...
### [numériques (STL/CLR)](numeric-stl-clr.md)
...
### [Vue d'ensemble du marshaling dans C++](overview-of-marshaling-in-cpp.md)
#### [marshal_as](marshal-as.md)
#### [marshal_context, classe](marshal-context-class.md)
...
##### [auto_gcroot, classe](auto-gcroot-class.md)
###### [auto_gcroot, membres](auto-gcroot-members.md)
...
##### [swap, fonction (auto_gcroot)](swap-function-auto-gcroot.md)
...
### [com::ptr](com-ptr.md)
#### [com::ptr, classe](com-ptr-class.md)
...
### [finally](finally.md)
### [Comment : intercepter des exceptions en code natif levées à partir de MSIL](how-to-catch-exceptions-in-native-code-thrown-from-msil.md)
### [Comment : définir et installer un gestionnaire d'exceptions global](how-to-define-and-install-a-global-exception-handler.md)
## [Boxing (C++/CLI)](boxing-cpp-cli.md)
### [Comment : demander explicitement le boxing](how-to-explicitly-request-boxing.md)
### [Comment : utiliser gcnew pour créer des types de valeur et utiliser un boxing implicite](how-to-use-gcnew-to-create-value-types-and-use-implicit-boxing.md)
### [Comment : effectuer une conversion unbox](how-to-unbox.md)
