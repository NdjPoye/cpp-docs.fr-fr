...
## Notes  
 La fonction membre retourne vrai pour une séquence contrôlée vide.  Équivaut à [priority\_queue::size](../dotnet/priority-queue-size-stl-clr.md)`() == 0`.  Vous l'utilisez pour tester si la liste de priorités est vide.  
