...
Supprime le dernier élément sélectionné.  
...
## Notes  
 La fonction membre supprime le dernier élément de la séquence contrôlée, qui doit être non\-vide.  Vous l'utilisez pour raccourcir la liste d'un élément au bout.  
