...
### [Guide pratique pour effectuer une migration vers /clr:pure (C++-CLI)](how-to-migrate-to-clr-pure-cpp-cli.md)
...
## [Sérialisation (C# )](serialization-cpp-cli.md)
