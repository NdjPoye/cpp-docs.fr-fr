...
### <a name="remarks"></a>Notes  
 La fonction de modèle exécute `left.`[unordered_set::swap](../standard-library/unordered-set-class.md#unordered_set__swap)`(right)`.  
...
### <a name="remarks"></a>Notes  
 La fonction de modèle exécute `left.`[unordered_multiset::swap](../standard-library/unordered-multiset-class.md#unordered_multiset__swap)`(right)`.  
