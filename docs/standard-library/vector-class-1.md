---
title: "Vector, classe 1 | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
La classe vector de STL est une classe de modèle de conteneurs de séquence qui organisent les éléments d'un type donné selon une arrangement linéaire et permettent ainsi un accès aléatoire rapide à n'importe quel élément. Ils doivent être les conteneurs préférés pour une séquence quand les performances de l'accès aléatoire sont une priorité.  
...
## <a name="remarks"></a>Notes  
 Les vecteurs gèrent les insertions et suppressions en temps fixe à la fin de la séquence. Ailleurs dans le vecteur, les insertions et suppressions d'éléments doivent s'effectuer en temps linéaire. Les performances de la [classe deque](../standard-library/deque-class.md) conteneur est recommandé pour les insertions et suppressions au début et à la fin d’une séquence. Le [list, classe](../standard-library/list-class.md) conteneur est recommandé pour les insertions et suppressions réalisées à n’importe quel emplacement dans une séquence.  
 ...
 Le [vector \< bool> classe](../standard-library/vector-bool-class.md) est une spécialisation complète de la classe de modèle vector pour les éléments de type booléen possédant un allocateur pour le type sous-jacent utilisé par la spécialisation.  
  
 Le [vector \< bool> reference, classe](../standard-library/vector-bool-class.md#vector_lt_bool_gt___reference_class) est une classe imbriquée dont les objets sont en mesure de fournir des références aux éléments (bits uniques) au sein d’un vecteur \< bool> objet.  
...
|||  
|-|-|  
|[vecteur](#vector__vector)|Construit un vecteur de taille spécifique ou contenant des éléments de valeurs spécifiques, ou contenant un objet `allocator` spécifique, ou comme copie d'un autre vecteur.|  
  
### <a name="typedefs"></a>Typedefs  
  
|||  
|-|-|  
|[allocator_type](#vector__allocator_type)|Type qui représente la classe `allocator` pour l'objet vector.|  
|[const_iterator](#vector__const_iterator)|Type qui fournit un itérateur à accès aléatoire qui peut lire un élément `const` dans un vecteur.|  
|[const_pointer](#vector__const_pointer)|Type qui fournit un pointeur vers un élément `const` d'un vecteur.|  
|[const_reference](#vector__const_reference)|Type qui fournit une référence à un élément `const` stocké dans un vecteur pour la lecture et l'exécution d'opérations `const`.|  
|[const_reverse_iterator](#vector__const_reverse_iterator)|Type qui fournit un itérateur à accès aléatoire pouvant lire n'importe quel élément `const` dans le vecteur.|  
|[difference_type](#vector__difference_type)|Type qui fournit la différence entre les adresses de deux éléments dans un vecteur.|  
|[itérateur](#vector__iterator)|Type qui fournit un itérateur à accès aléatoire pour lire ou modifier un élément dans un vecteur.|  
|[pointeur](#vector__pointer)|Type qui fournit un pointeur vers un élément d'un vecteur.|  
|[référence](#vector__reference)|Type qui fournit une référence à un élément stocké dans un vecteur.|  
|[reverse_iterator](#vector__reverse_iterator)|Type qui fournit un itérateur à accès aléatoire pouvant lire ou modifier un élément d'un vecteur inversé.|  
|[size_type](#vector__size_type)|Type qui compte le nombre d'éléments dans un vecteur.|  
|[Value_type](#vector__value_type)|Type représentant le type de données stockées dans un vecteur.|  
  
### <a name="member-functions"></a>Fonctions membres  
  
|||  
|-|-|  
|[attribuer](#vector__assign)|Efface un tableau et copie les éléments spécifiés dans le vecteur vide.|  
|[à](#vector__at)|Retourne une référence à l'élément à un emplacement spécifié dans le vecteur.|  
|[Précédent](#vector__back)|Retourne une référence au dernier élément du vecteur.|  
|[commencer](#vector__begin)|Retourne un itérateur à accès aléatoire pointant vers le premier élément dans le vecteur.|  
|[capacité](#vector__capacity)|Retourne le nombre d'éléments que le vecteur peut contenir sans avoir à allouer plus de stockage.|  
|[cbegin](#vector__cbegin)|Retourne un itérateur const à accès aléatoire pointant vers le premier élément du vecteur.|  
|[cend](#vector__cend)|Retourne un itérateur const à accès aléatoire qui pointe juste après la fin du vecteur.|  
|[crbegin](#vector__crbegin)|Retourne un itérateur const qui pointe vers le premier élément d'un vecteur inversé.|  
|[crend](#vector__crend)|Retourne un itérateur const qui pointe vers la fin d'un vecteur inversé.|  
|[Effacer](#vector__clear)|Supprime les éléments du vecteur.|  
|[données](#vector__data)|Retourne un pointeur vers le premier élément du vecteur.|  
|[emplace)](#vector__emplace)|Insère un élément construit sur place à la position spécifiée dans le vecteur.|  
|[emplace_back](#vector__emplace_back)|Ajoute un élément construit sur place à la fin du vecteur.|  
|[vide](#vector__empty)|Teste si le conteneur vecteur est vide.|  
|[fin](#vector__end)|Retourne un itérateur à accès aléatoire qui pointe vers la fin du vecteur.|  
|[effacement](#vector__erase)|Supprime un élément ou une plage d'éléments aux positions spécifiées dans le vecteur.|  
|[premier plan](#vector__front)|Retourne une référence au premier élément du vecteur.|  
|[get_allocator](#vector__get_allocator)|Retourne un objet à la classe `allocator` utilisée par un vecteur.|  
|[Insérer](#vector__insert)|Insère un ou plusieurs éléments à la position spécifiée dans le vecteur.|  
|[max_size](#vector__max_size)|Retourne la longueur maximale autorisée du vecteur.|  
|[pop_back](#vector__pop_back)|Supprime l'élément à la fin du vecteur.|  
|[push_back](#vector__push_back)|Ajoute un élément à la fin du vecteur.|  
|[rbegin](#vector__rbegin)|Retourne un itérateur pointant vers le premier élément d'un vecteur inverse.|  
|[rend)](#vector__rend)|Retourne un itérateur qui pointe vers la fin d'un vecteur inversé.|  
|[réserve](#vector__reserve)|Réserve une taille de stockage minimale pour un vecteur.|  
|[redimensionner](#vector__resize)|Spécifie une nouvelle taille pour un vecteur.|  
|[shrink_to_fit](#vector__shrink_to_fit)|Ignore la capacité excédentaire.|  
|[taille](#vector__size)|Retourne le nombre d'éléments figurant dans le vecteur.|  
|[échange](#vector__swap)|Échange les éléments de deux vecteurs.|  
  
### <a name="operators"></a>Opérateurs  
  
|||  
|-|-|  
|[opérateur &#91 ; &#93 ;](#vector__operator_at)|Retourne une référence à l'élément de vecteur à un emplacement spécifié.|  
|[opérateur =](#vector__operator_eq)|Remplace les éléments du vecteur par une copie d'un autre vecteur.|  
...
### <a name="example"></a>Exemple  
  Consultez l’exemple de [get_allocator](#vector__get_allocator) pour obtenir un exemple qui utilise `allocator_type`.  
...
### <a name="return-value"></a>Valeur de retour  
 Référence à l’élément en indice dans l’argument. Si `_Off` est supérieure à la taille du vecteur, **à** lève une exception.  
  
### <a name="remarks"></a>Notes  
 Si la valeur de retour de **à** est affecté à un `const_reference`, le vecteur ne peut pas être modifié. Si la valeur de retour de **à** est affecté à un **référence**, le vecteur peut être modifié.  
...
### <a name="remarks"></a>Notes  
 Si la valeur de retour de **retour** est affecté à un `const_reference`, le vecteur ne peut pas être modifié. Si la valeur de retour de **retour** est affecté à un **référence**, le vecteur peut être modifié.  
  
 Dans le cadre d'une compilation avec _SECURE_SCL 1, une erreur d'exécution se produit si vous essayez d'accéder à un élément d'un vecteur vide.  Pour plus d'informations, voir [Checked Iterators](../standard-library/checked-iterators.md) .  
...
### <a name="return-value"></a>Valeur de retour  
 Un itérateur à accès aléatoire traite le premier élément dans le `vector` ou à l’emplacement suivant vide `vector`. Vous devez toujours comparer la valeur retournée avec [vector::end](#vector__end) pour vous assurer qu’il est valide.  
  
### <a name="remarks"></a>Notes  
 Si la valeur de retour de `begin` est affecté à un [vector::const_iterator](#vector__const_iterator), le `vector` objet ne peut pas être modifié. Si la valeur de retour de `begin` est affecté à un [vector::iterator](#vector__iterator), le `vector` objet peut être modifié.  
...
### <a name="remarks"></a>Notes  
 La fonction membre [redimensionner](#vector__resize) sera plus efficace si suffisamment de mémoire est allouée pour répondre à ses besoins. Utilisez la fonction membre [réserver](#vector__reserve) pour spécifier la quantité de mémoire allouée.  
...
### <a name="example"></a>Exemple  
  Consultez l’exemple de [retour](#vector__back) pour obtenir un exemple qui utilise `const_iterator`.  
  
##  <a name="a-namevectorconstpointera-vectorconstpointer"></a><a name="vector__const_pointer"></a>  Vector::const_pointer  
 Type qui fournit un pointeur vers un **const** élément dans un vecteur.  
...
### <a name="remarks"></a>Notes  
 ...
 Un [itérateur](#vector__iterator) est généralement utilisé pour accéder à un élément de vecteur.  
  
##  <a name="a-namevectorconstreferencea-vectorconstreference"></a><a name="vector__const_reference"></a>  Vector::const_reference  
 Type qui fournit une référence à un **const** élément stocké dans un vecteur pour lire et effectuer **const** operations.  
...
##  <a name="a-namevectorconstreverseiteratora-vectorconstreverseiterator"></a><a name="vector__const_reverse_iterator"></a>  Vector::const_reverse_iterator  
 Type qui fournit un itérateur à accès aléatoire capable de lire un **const** élément dans le vecteur.  
...
### <a name="remarks"></a>Notes  
 Un type `const_reverse_iterator` ne peuvent pas modifier la valeur d’un élément et est utilisé pour itérer le vecteur dans l’ordre inverse.  
  
### <a name="example"></a>Exemple  
  Consultez la page [rbegin](#vector__rbegin) pour obtenir un exemple montrant comment déclarer et utiliser un itérateur.  
...
### <a name="return-value"></a>Valeur de retour  
 Itérateur à accès aléatoire traite le premier élément dans une liste inversée inverse const [vecteur](vector%20Class.md) ou de traiter ce qui a été le dernier élément de la non inversé `vector`.  
...
##  <a name="a-namevectorcrenda-vectorcrend"></a><a name="vector__crend"></a>  Vector::crend  
 Retourne un itérateur const qui traite l’emplacement suivant le dernier élément d’un vecteur inverse.  
...
### <a name="return-value"></a>Valeur de retour  
 Itérateur à accès aléatoire qui traite l’emplacement suivant le dernier élément dans une liste inversée inverse const [vecteur](vector%20Class.md) (l’emplacement ayant précédé le premier élément dans la non inversé `vector`).  
  
### <a name="remarks"></a>Notes  
 `crend` est utilisé avec un inversée `vector` comme [vector::cend](#vector__cend) est utilisé avec un `vector`.  
  
 Avec la valeur de retour de `crend` (convenablement décrémenté), la `vector` objet ne peut pas être modifié.  
...
### <a name="return-value"></a>Valeur de retour  
 Un pointeur vers le premier élément de la [vecteur](vector%20Class.md) ou à l’emplacement suivant vide `vector`.  
...
### <a name="remarks"></a>Notes  
 Un `difference_type` peut également être décrite comme le nombre d’éléments entre deux pointeurs, car un pointeur vers un élément contient son adresse.  
...
|`_Where`|La position dans le [vecteur](vector%20Class.md) où le premier élément est inséré.|  
...
### <a name="remarks"></a>Notes  
 Une opération d’insertion peut s’avérer coûteuse, consultez [vector, classe](vector%20Class.md) pour en savoir plus sur `vector` performances.  
...
### <a name="remarks"></a>Notes  
 Si la valeur de retour de **fin** est affecté à une variable de type `const_iterator`, le vecteur ne peut pas être modifié. Si la valeur de retour de **fin** est affecté à une variable de type **itérateur**, le vecteur peut être modifié.  
...
### <a name="remarks"></a>Notes  
 Si la valeur de retour de `front` est assignée à `const_reference`, il est impossible de modifier l'objet de vecteur. Si la valeur de retour de `front` est affecté à un **référence**, le vecteur peut être modifié.  
...
### <a name="example"></a>Exemple  
  Consultez l’exemple de [commencer](#vector__begin).  
...
### <a name="remarks"></a>Notes  
 ...
 Lors de la compilation avec _SECURE_SCL 1 (contrôlée avec [_ITERATOR_DEBUG_LEVEL](../standard-library/iterator-debug-level.md)), une erreur d’exécution se produit si vous tentez d’accéder à un élément en dehors des limites du vecteur.  Pour plus d'informations, voir [Checked Iterators](../standard-library/checked-iterators.md) .  
...
|-|-|  
|Paramètre|Description|  
|` right`|Le [vecteur](vector%20Class.md) copiées dans le `vector`.|  
...
### <a name="remarks"></a>Notes  
 Un type **pointeur** peut être utilisé pour modifier la valeur d’un élément.  
...
### <a name="remarks"></a>Notes  
 Pour obtenir un exemple de code, consultez [vector ::push_back()](#vector__push_back).  
...
### <a name="return-value"></a>Valeur de retour  
 Un itérateur à accès aléatoire inverse traite le premier élément d’un vecteur inverse ou de traiter ce qui a été le dernier élément dans le vecteur non inversé.  
  
### <a name="remarks"></a>Notes  
 Si la valeur de retour de `rbegin` est assignée à `const_reverse_iterator`, il est impossible de modifier l'objet de vecteur. Si la valeur de retour de `rbegin` est affecté à un `reverse_iterator`, le vecteur peut être modifié.  
...
### <a name="example"></a>Exemple  
  Consultez [à](#vector__at) pour obtenir un exemple montrant comment utiliser **référence** dans la classe vector.  
  
##  <a name="a-namevectorrenda-vectorrend"></a><a name="vector__rend"></a>  Vector::rend  
 Retourne un itérateur qui traite l’emplacement suivant le dernier élément d’un vecteur inverse.  
...
### <a name="return-value"></a>Valeur de retour  
 Un itérateur à accès aléatoire inverse qui traite l’emplacement suivant le dernier élément d’un vecteur inverse (l’emplacement ayant précédé le premier élément dans le vecteur non inversé).  
  
### <a name="remarks"></a>Notes  
 `rend` est utilisé avec un vecteur inverse comme [fin](#vector__end) est utilisé avec un vecteur.  
  
 Si la valeur de retour de `rend` est affecté à un `const_reverse_iterator`, puis le vecteur ne peut pas être modifié. Si la valeur de retour de `rend` est affecté à un `reverse_iterator`, puis le vecteur peut être modifié.  
  
 `rend` peut être utilisé pour tester si un itérateur inverse a atteint la fin du vecteur.  
...
### <a name="remarks"></a>Notes  
 ...
 [taille](#vector__size) reflète la taille actuelle du vecteur.  
...
### <a name="example"></a>Exemple  
  Consultez l’exemple de [rbegin](#vector__rbegin).  
...
### <a name="example"></a>Exemple  
  Consultez l’exemple de [capacité](#vector__capacity).  
...
|-|-|  
|Paramètre|Description|  
|`Al`|Classe allocator à utiliser avec cet objet. [get_allocator](#vector__get_allocator) retourne la classe d’allocateur de l’objet.|  
...
|`IList`|Objet initializer_list contenant l’elmeents à copier.|  
...
### <a name="remarks"></a>Notes  
 ...
 Les neuvième et dixième constructeurs copient la plage [ `First`, `Last`) d’un vecteur.  
