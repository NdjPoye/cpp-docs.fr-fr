---
title: "Fichiers d&#39;en-t&#234;te de biblioth&#232;que standard C++ | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "fichiers d'en-tête, bibliothèque C++ standard"
  - "en-têtes, bibliothèque C++ standard"
  - "bibliothèques, C++ (fichiers d'en-tête)"
  - "bibliothèque C++ standard, fichiers d'en-tête"
  - "Visual C++, fichiers d'en-tête"
  - "wrappers"
...
Fichiers d'en\-tête pour la bibliothèque C\+\+ standard et les extensions, par catégorie.  
 ...
 `Algorithms` \[[plus d'informations](../cpp/algorithms-modern-cpp.md)\]  
 ...
 `Containers` \[[plus d'informations](../cpp/containers-modern-cpp.md)\]  
 `Sequence`  
 ...
 `Error Handling` \[[plus d'informations](../cpp/errors-and-exception-handling-modern-cpp.md)\]  
 ...
 `Input/Output` \[[plus d'informations](../cpp/string-and-i-o-formatting-modern-cpp.md)\]  
 ...
 `Memory Management` \[[plus d'informations](../cpp/smart-pointers-modern-cpp.md)\]  
 ...
 `Multithreading`  
 [\<atomic\>](../standard-library/atomic.md), [\<variable\_condition\>](../standard-library/condition-variable.md), [\<future\>](../standard-library/future.md), [\<mutex\>](../standard-library/mutex.md), [\<shared\_mutex\>](../standard-library/shared-mutex.md), [\<thread\>](../standard-library/thread.md)  
