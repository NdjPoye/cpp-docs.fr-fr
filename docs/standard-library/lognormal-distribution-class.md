...
|`lognormal_distribution::operator()`|`lognormal_distribution::s`|[lognormal\_distribution::param\_type](../Topic/lognormal_distribution::param_type.md)|  
 ...
 Pour plus d'informations sur la distribution suivant une loi log\-normale, voir l'article de Wolfram MathWorld [LogNormal Distribution](http://go.microsoft.com/fwlink/?LinkId=400917).  
