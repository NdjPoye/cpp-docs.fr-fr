...
Utilisez la [fonction get &lt;utility&gt;](../standard-library/utility-functions.md#get) pour retourner l’élément à une position spécifiée ou (dans C++14 / Visual Studio 2015) d’un type spécifié. 
