...
|[nth_element](../standard-library/algorithm-functions.md#nth_element)|Divise une plage d’éléments, en recherchant le  *n* ième élément de la séquence de la plage afin que tous les éléments le précédant lui soient inférieur ou égal à celui-ci et tous les éléments qui suivent dans la séquence sont supérieur ou égal à celui-ci.|  
