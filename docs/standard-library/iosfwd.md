...
Déclare des références aval à plusieurs classes du modèle utilisées dans tous des iostreams.  Toutes ces classes du modèle sont définies dans d'autres en\-têtes standard.  Vous incluez cet en\-tête explicitement uniquement lorsque vous avez besoin d'une de ses déclarations, mais pas la définition.  
...
## Déclarations anticipé\/classes du modèle  
