...
>  L'objet allocateur stocké n'est pas copié quand l'objet conteneur est assigné.  
 ...
 Des ajouts à la séquence contrôlée peuvent être effectués par des appels à [forward_list::insert_after](#forward_list__insert_after), qui est la seule fonction membre qui appelle le constructeur `Type(const  T&)`. `forward_list` peut également appeler des constructeurs de déplacement. Si une telle expression lève une exception, l'objet conteneur n'insère aucun nouvel élément et relève l'exception. Ainsi, un objet de classe de modèle `forward_list` est laissé dans un état connu quand ces exceptions se produisent.  
  
### <a name="constructors"></a>Constructeurs  
  
|||  
|-|-|  
|[forward_list](#forward_list__forward_list)|Construit un objet de type `forward_list`.|  
  
### <a name="typedefs"></a>Typedefs  
  
|||  
|-|-|  
|[allocator_type](#forward_list__allocator_type)|Type qui représente la classe d'allocateur pour un forward_list.|  
|[const_iterator](#forward_list__const_iterator)|Type qui fournit un itérateur constant pour le forward_list.|  
|[const_pointer](#forward_list__const_pointer)|Type qui fournit un pointeur vers un élément `const` dans un forward_list.|  
|[const_reference](#forward_list__const_reference)|Type qui fournit une référence constante à un élément dans le forward_list.|  
|[difference_type](#forward_list__difference_type)|Type entier signé qui peut être utilisé pour représenter le nombre d'éléments d'un forward_list au sein d'une plage, parmi les éléments vers lesquels pointent les itérateurs.|  
|[iterator](#forward_list__iterator)|Type qui fournit un itérateur pour le forward_list.|  
|[pointer](#forward_list__pointer)|Type qui fournit un pointeur vers un élément du forward_list.|  
|[reference](#forward_list__reference)|Type qui fournit une référence à un élément du forward_list.|  
|[size_type](#forward_list__size_type)|Type qui représente la distance non signée entre deux éléments.|  
|[value_type](#forward_list__value_type)|Type qui représente le type d'élément stocké dans un forward_list.|  
  
### <a name="member-functions"></a>Fonctions membres  
  
|||  
|-|-|  
|[assign](#forward_list__assign)|Efface les éléments d'un forward_list et copie un nouvel ensemble d'éléments dans un forward_list cible.|  
|[before_begin](#forward_list__before_begin)|Retourne un itérateur qui traite la position avant le premier élément dans un forward_list.|  
|[begin](#forward_list__begin)|Retourne un itérateur qui traite le premier élément d'un forward_list.|  
|[cbefore_begin](#forward_list__cbefore_begin)|Retourne un itérateur const qui traite la position avant le premier élément dans un forward_list.|  
|[cbegin](#forward_list__cbegin)|Retourne un itérateur const qui traite le premier élément d'un forward_list.|  
|[cend](#forward_list__cend)|Retourne un itérateur const qui traite l'emplacement suivant le dernier élément d'un forward_list.|  
|[clear](#forward_list__clear)|Efface tous les éléments d'un forward_list.|  
|[emplace_after](#forward_list__emplace_after)|Construit par déplacement un nouvel élément après la position spécifiée.|  
|[emplace_front](#forward_list__emplace_front)|Ajoute un élément construit sur place au début de la liste.|  
|[empty](#forward_list__empty)|Teste si un forward_list est vide.|  
|[end](#forward_list__end)|Retourne un itérateur qui traite l'emplacement suivant le dernier élément d'un forward_list.|  
|[erase_after](#forward_list__erase_after)|Supprime les éléments du forward_list après une position spécifiée.|  
|[front](#forward_list__front)|Retourne une référence au premier élément d'un forward_list.|  
|[get_allocator](#forward_list__get_allocator)|Retourne une copie de l'objet allocateur utilisé pour construire un forward_list.|  
|[insert_after](#forward_list__insert_after)|Ajoute des éléments au forward_list après une position spécifiée.|  
|[max_size](#forward_list__max_size)|Retourne la longueur maximale d'un forward_list.|  
|[merge](#forward_list__merge)|Supprime les éléments de la liste d'arguments, les insère dans le forward_list cible, puis classe le nouvel ensemble combiné d'éléments dans l'ordre croissant ou dans un autre ordre spécifique.|  
|[pop_front](#forward_list__pop_front)|Supprime l'élément au début d'un forward_list.|  
|[push_front](#forward_list__push_front)|Ajoute un élément au début d'un forward_list.|  
|[remove](#forward_list__remove)|Efface les éléments dans un forward_list qui correspond à une valeur spécifiée.|  
|[remove_if](#forward_list__remove_if)|Efface les éléments d’un forward_list pour lequel un prédicat spécifié est satisfait.|  
|[resize](#forward_list__resize)|Spécifie une nouvelle taille pour un forward_list.|  
|[reverse](#forward_list__reverse)|Inverse l'ordre dans lequel les éléments apparaissent dans un forward_list.|  
|[sort](#forward_list__sort)|Réorganise les éléments dans l’ordre croissant ou dans un ordre spécifié par un prédicat.|  
|[splice_after](#forward_list__splice_after)|Réassocie les liens entre les nœuds.|  
|[swap](#forward_list__swap)|Échange les éléments de deux forward_list.|  
|[unique](#forward_list__unique)|Supprime des éléments adjacents qui réussissent un test spécifié.|  
  
### <a name="operators"></a>Opérateurs  
  
|||  
|-|-|  
|[operator=](#forward_list__operator_eq)|Remplace les éléments du forward_list par une copie d'un autre forward_list.|  
...
### <a name="remarks"></a>Notes  
 Cette fonction membre insère un élément avec les arguments de constructeur ` val` juste après l’élément désigné par `Where` dans la séquence contrôlée. Sinon, son comportement est identique à celui de [forward_list::insert_after](#forward_list__insert_after).  
...
### <a name="return-value"></a>Valeur de retour  
 Itérateur qui désigne le premier élément restant après tous les éléments supprimés, ou [forward_list::end](#forward_list__end) si aucun élément de ce genre n’existe.  
...
### <a name="remarks"></a>Notes  
 ...
 Si la méthode splice à plage insère `N` éléments et que `&Source != this`, un objet de classe [iterator](#forward_list__iterator) est incrémenté `N` fois.  
