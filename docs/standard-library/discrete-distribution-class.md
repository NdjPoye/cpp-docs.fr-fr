...
-  Si *count* > 0, **n** = *count*. Si **d** = (*high* - *low*) / **n** est supérieur à zéro, qui utilise des sous-plages uniformes **d**, chaque poids est assigné comme suit : `weight[k] = weightfunc(x)`, où **x** = *low* + **k** * **d** + **d** / 2, pour **k** = 0, ..., **n** - 1.  
