...
## <a name="remarks"></a>Notes  
 La valeur retournée par la [classe exception](../standard-library/exception-class.md) est une copie de **message**`.`[data](../standard-library/basic-string-class.md#basic_string__data).  
