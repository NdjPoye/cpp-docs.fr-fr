...
## <a name="remarks"></a>Notes  
 Les objets de type `char *` peuvent utiliser la fonctionnalité de [ \<strstream>](../standard-library/strstream.md) pour les flux. Toutefois, `<strstream>` étant déprécié, il est préférable d’utiliser `<sstream>`.  
