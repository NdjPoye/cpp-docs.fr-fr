...
|||  
|-|-|  
|[errc, énumération](#errc_enumeration)|[io_errc, énumération](#io_errc_enumeration)|  
  
##  <a name="a-nameerrcenumerationa--errc-enumeration"></a><a name="errc_enumeration"></a>  errc, énumération  
...
##  <a name="a-nameioerrcenumerationa--ioerrc-enumeration"></a><a name="io_errc_enumeration"></a>  io_errc, énumération  
 Fournit des noms symboliques pour les conditions d’erreur dans \<iostream>. Peut être utilisée pour créer des objets [error_condition](../standard-library/error-condition-class.md) à comparer avec la valeur retournée par la fonction [ios_base::failure](../standard-library/ios-base-class.md#ios_base__failure)`code()`.  
