...
|Nom|Description|  
|----------|-----------------|  
|[shared_future::shared_future, constructeur](#shared_future__shared_future_constructor)|Construit un objet `shared_future`.|  
  
### <a name="public-methods"></a>M&#233;thodes publiques  
  
|Nom|Description|  
|----------|-----------------|  
|[shared_future::get, méthode](#shared_future__get_method)|Récupère le résultat qui est stocké dans l’*état asynchrone associé*.|  
|[shared_future::valid, méthode](#shared_future__valid_method)|Spécifie si l’objet n’est pas vide.|  
|[shared_future::wait, méthode](#shared_future__wait_method)|Bloque le thread actuel jusqu’à ce que l’état asynchrone associé soit prêt.|  
|[shared_future::wait_for, méthode](#shared_future__wait_for_method)|Bloque le thread actuel jusqu’à ce que l’état asynchrone associé soit prêt ou que le délai spécifié soit écoulé.|  
|[shared_future::wait_until, méthode](#shared_future__wait_until_method)|Bloque le thread actuel jusqu’à ce que l’état asynchrone associé soit prêt ou jusqu’à un point spécifié dans le temps.|  
  
### <a name="public-operators"></a>Op&#233;rateurs publics  
  
|Nom|Description|  
|----------|-----------------|  
|[shared_future::operator=](#shared_future__operator_eq)|Assigne un nouvel état asynchrone associé.|  
...
##  <a name="a-namesharedfuturegetmethoda--sharedfutureget-method"></a><a name="shared_future__get_method"></a>  shared_future::get, méthode  
...
##  <a name="a-namesharedfuturesharedfutureconstructora--sharedfuturesharedfuture-constructor"></a><a name="shared_future__shared_future_constructor"></a>  shared_future::shared_future, constructeur  
...
##  <a name="a-namesharedfuturevalidmethoda--sharedfuturevalid-method"></a><a name="shared_future__valid_method"></a>  shared_future::Valid, méthode  
...
##  <a name="a-namesharedfuturewaitmethoda--sharedfuturewait-method"></a><a name="shared_future__wait_method"></a>  shared_future::wait, méthode  
...
##  <a name="a-namesharedfuturewaitformethoda--sharedfuturewaitfor-method"></a><a name="shared_future__wait_for_method"></a>  shared_future::wait_for, méthode  
...
##  <a name="a-namesharedfuturewaituntilmethoda--sharedfuturewaituntil-method"></a><a name="shared_future__wait_until_method"></a>  shared_future::wait_until, méthode  
