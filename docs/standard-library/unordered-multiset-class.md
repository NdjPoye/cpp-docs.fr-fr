...
|[unordered_multiset::allocator_type](#unordered_multiset__allocator_type)|Type d’un allocateur pour la gestion du stockage.|  
|[unordered_multiset::const_iterator](#unordered_multiset__const_iterator)|Type d'un itérateur constant pour la séquence contrôlée.|  
|[unordered_multiset::const_local_iterator](#unordered_multiset__const_local_iterator)|Type d’un itérateur de compartiment constant pour la séquence contrôlée.|  
|[unordered_multiset::const_pointer](#unordered_multiset__const_pointer)|Type d'un pointeur constant vers un élément.|  
|[unordered_multiset::const_reference](#unordered_multiset__const_reference)|Type d'une référence constante à un élément.|  
|[unordered_multiset::difference_type](#unordered_multiset__difference_type)|Type d'une distance signée entre deux éléments.|  
|[unordered_multiset::hasher](#unordered_multiset__hasher)|Type de la fonction de hachage.|  
|[unordered_multiset::iterator](#unordered_multiset__iterator)|Type d'un itérateur pour la séquence contrôlée.|  
|[unordered_multiset::key_equal](#unordered_multiset__key_equal)|Type de la fonction de comparaison.|  
|[unordered_multiset::key_type](#unordered_multiset__key_type)|Type d'une clé de tri.|  
|[unordered_multiset::local_iterator](#unordered_multiset__local_iterator)|Type d'un itérateur de compartiment pour la séquence contrôlée.|  
|[unordered_multiset::pointer](#unordered_multiset__pointer)|Type d'un pointeur vers un élément.|  
|[unordered_multiset::reference](#unordered_multiset__reference)|Type d'une référence à un élément.|  
|[unordered_multiset::size_type](#unordered_multiset__size_type)|Type d'une distance non signée entre deux éléments.|  
|[unordered_multiset::value_type](#unordered_multiset__value_type)|Type d’un élément.|  
  
|||  
|-|-|  
|Fonction membre|Description|  
|[unordered_multiset::begin](#unordered_multiset__begin)|Désigne le début de la séquence contrôlée.|  
|[unordered_multiset::bucket](#unordered_multiset__bucket)|Obtient le numéro du compartiment pour une valeur de clé.|  
|[unordered_multiset::bucket_count](#unordered_multiset__bucket_count)|Obtient le nombre de compartiments.|  
|[unordered_multiset::bucket_size](#unordered_multiset__bucket_size)|Obtient la taille d'un compartiment.|  
|[unordered_multiset::cbegin](#unordered_multiset__cbegin)|Désigne le début de la séquence contrôlée.|  
|[unordered_multiset::cend](#unordered_multiset__cend)|Désigne la fin de la séquence contrôlée.|  
|[unordered_multiset::clear](#unordered_multiset__clear)|Supprime tous les éléments.|  
|[unordered_multiset::count](#unordered_multiset__count)|Recherche le nombre d’éléments qui correspondent à une clé spécifiée.|  
|[unordered_multiset::emplace](#unordered_multiset__emplace)|Ajoute un élément construit sur place.|  
|[unordered_multiset::emplace_hint](#unordered_multiset__emplace_hint)|Ajoute un élément construit sur place, avec un indicateur.|  
|[unordered_multiset::empty](#unordered_multiset__empty)|Vérifie l'absence d'éléments.|  
|[unordered_multiset::end](#unordered_multiset__end)|Désigne la fin de la séquence contrôlée.|  
|[unordered_multiset::equal_range](#unordered_multiset__equal_range)|Recherche une plage qui correspond à une clé spécifiée.|  
|[unordered_multiset::erase](#unordered_multiset__erase)|Supprime les éléments placés aux positions spécifiées.|  
|[unordered_multiset::find](#unordered_multiset__find)|Recherche un élément qui correspond à une clé spécifiée.|  
|[unordered_multiset::get_allocator](#unordered_multiset__get_allocator)|Obtient l’objet allocateur stocké.|  
|[unordered_multiset::hash_function](#unordered_multiset__hash_function)|Obtient l'objet de fonction de hachage stocké.|  
|[unordered_multiset::insert](#unordered_multiset__insert)|Ajoute des éléments.|  
|[unordered_multiset::key_eq](#unordered_multiset__key_eq)|Obtient l'objet de fonction de comparaison stocké.|  
|[unordered_multiset::load_factor](#unordered_multiset__load_factor)|Compte le nombre moyen d'éléments par compartiment.|  
|[unordered_multiset::max_bucket_count](#unordered_multiset__max_bucket_count)|Obtient le nombre maximal de compartiments.|  
|[unordered_multiset::max_load_factor](#unordered_multiset__max_load_factor)|Obtient ou définit le nombre maximal d’éléments par compartiment.|  
|[unordered_multiset::max_size](#unordered_multiset__max_size)|Obtient ou définit la taille maximale de la séquence contrôlée.|  
|[unordered_multiset::rehash](#unordered_multiset__rehash)|Régénère la table de hachage.|  
|[unordered_multiset::size](#unordered_multiset__size)|Compte le nombre d'éléments.|  
|[unordered_multiset::swap](#unordered_multiset__swap)|Échange le contenu de deux conteneurs.|  
|[unordered_multiset::unordered_multiset](#unordered_multiset__unordered_multiset)|Construit un objet conteneur.|  
  
|||  
|-|-|  
|Opérateur|Description|  
|[unordered_multiset::operator=](#unordered_multiset__operator_eq)|Copie une table de hachage.|  
  
## <a name="remarks"></a>Notes  
 L’objet trie la séquence qu’il contrôle en appelant deux objets stockés, un objet de fonction de comparaison de type [unordered_multiset::key_equal](#unordered_multiset__key_equal) et un objet de fonction de hachage de type [unordered_multiset::hasher](#unordered_multiset__hasher). Pour accéder au premier objet stocké, appelez la fonction membre [unordered_multiset::key_eq](#unordered_multiset__key_eq)`()`. Pour accéder au second objet stocké, appelez la fonction membre [unordered_multiset::hash_function](#unordered_multiset__hash_function)`()`. Pour toutes les valeurs `X` et `Y` de type `Key`, l'appel `key_eq()(X, Y)` retourne true uniquement si les valeurs des deux arguments ont un classement équivalent. L'appel `hash_function()(keyval)` génère une distribution des valeurs de type `size_t`. Contrairement à la classe de modèle [unordered_set](../standard-library/unordered-set-class.md), un objet de classe de modèle `unordered_multiset` ne garantit pas que `key_eq()(X, Y)` a toujours la valeur false pour deux éléments quelconques de la séquence contrôlée. Il n'est pas nécessaire que les clés soient uniques.  
  
 L'objet stocke également un facteur de charge maximale, qui spécifie le nombre moyen maximal d'éléments souhaité par compartiment. Si après l’insertion d’un élément, [unordered_multiset::load_factor](#unordered_multiset__load_factor)`()` dépasse le facteur de charge maximale, le conteneur augmente le nombre de compartiments et reconstruit la table de hachage si nécessaire.  
...
### <a name="remarks"></a>Notes  
 La fonction membre appelle [unordered_multiset::erase](#unordered_multiset__erase)`(` [unordered_multiset::begin](#unordered_multiset__begin)`(),` [unordered_multiset::end](#unordered_multiset__end)`())`.  
...
### <a name="remarks"></a>Notes  
 La fonction membre retourne le nombre d’éléments dans la plage délimitée par [unordered_multiset::equal_range](#unordered_multiset__equal_range)`(keyval)`.  
...
### <a name="remarks"></a>Remarques  
 ...
 Pour obtenir un exemple de code, consultez [multiset::emplace](../standard-library/multiset-class.md#multiset__emplace).  
...
### <a name="remarks"></a>Notes  
 La fonction membre retourne [unordered_multiset::equal_range](#unordered_multiset__equal_range)`(keyval).first`.  
...
|`ValTy`|Paramètre de modèle qui spécifie le type d’argument que la classe unordered_multiset peut utiliser pour construire un élément de [value_type](../standard-library/map-class.md#map__value_type) et effectue un transfert parfait de `Val` comme argument.|  
...
### <a name="remarks"></a>Notes  
 ...
 L’objet [value_type](../standard-library/map-class.md#map__value_type) d’un conteneur est un typedef qui appartient au conteneur et, pour la classe set, `unordered_multiset<V>::value_type` est de type `const V`.  
 ...
 Pour l’insertion d’un élément construit sur place (aucune opération de copie ni de déplacement n’est effectuée), consultez [unordered_multiset::emplace](#unordered_multiset__emplace) et [unordered_multiset::emplace_hint](#unordered_multiset__emplace_hint).  
  
 Pour obtenir un exemple de code, consultez [multiset::insert](../standard-library/multiset-class.md#multiset__insert).  
...
### <a name="example"></a>Exemple  
  Consultez l’exemple [begin](../standard-library/multiset-class.md#multiset__begin) qui illustre comment déclarer et utiliser un **itérateur**.  
...
### <a name="remarks"></a>Notes  
 La fonction membre retourne `(float)`[unordered_multiset::size](#unordered_multiset__size)`() / (float)`[unordered_multiset::bucket_count](#unordered_multiset__bucket_count)`()`, le nombre moyen d’éléments par compartiment.  
