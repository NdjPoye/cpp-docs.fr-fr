...
## Notes  
 La classe de modèle décrit une distribution qui produit des valeurs d'un type intégral spécifié par l'utilisateur, ou du type `double` si aucun n'est fourni, distribuées selon une loi Gamma.  Le tableau suivant contient des liens vers des articles sur différents membres.  
...
|`gamma_distribution::operator()`|`gamma_distribution::beta`|[gamma\_distribution::param\_type](../Topic/gamma_distribution::param_type.md)|  
 ...
 Pour plus d'informations sur la distribution Gamma, voir l'article de Wolfram MathWorld [Gamma Distribution](http://go.microsoft.com/fwlink/?LinkId=401111).  
