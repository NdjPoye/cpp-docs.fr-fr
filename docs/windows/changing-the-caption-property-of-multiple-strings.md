...
La procédure ci\-après indique comment modifier la propriété Caption de plusieurs chaînes.  
  
### Pour modifier la propriété Caption de plusieurs chaînes  
...
2.  Sélectionnez les chaînes que vous souhaitez modifier en maintenant la touche **CTRL** enfoncée tout en cliquant sur chacune d'elles.  
  
3.  Dans la [fenêtre Propriétés](../Topic/Properties%20Window.md), tapez une nouvelle valeur pour la propriété à modifier.  
