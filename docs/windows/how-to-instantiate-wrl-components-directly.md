...
Découvrez comment utiliser la bibliothèque de modèles C++ (WRL) de Windows Runtime[Microsoft::wrl :: Make](../windows/make-function.md) et [Microsoft::WRL::Details::MakeAndInitialize](../windows/makeandinitialize-function.md) pour instancier un composant à partir du module qui Il définit.  
 ...
 Pour savoir comment utiliser la bibliothèque de modèles Windows Runtime C++ pour créer un composant Windows Runtime de base et l’instancier à partir d’une application externe de la plateforme Windows universelle, consultez [procédure pas à pas : création d’un composant Windows Runtime base](../windows/walkthrough-creating-a-basic-windows-runtime-component-using-wrl.md). Pour savoir comment utiliser la bibliothèque de modèles Windows Runtime C++ pour créer un composant COM classique et l’instancier à partir d’une application de bureau externe, consultez [Comment : créer un composant COM classique](../windows/how-to-create-a-classic-com-component-using-wrl.md).  
