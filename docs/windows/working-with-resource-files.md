...
> [!WARNING]
>  Cette section concerne les applications de bureau Windows écrites en C\+\+. Pour plus d'informations sur les ressources dans les applications du [!INCLUDE[win8_appname_long](../build/includes/win8_appname_long_md.md)] écrites en C\+\+, consultez [Définition des ressources d'application](http://msdn.microsoft.com/fr-fr/476ea844-632c-4467-9ce3-966be1350dd4).  
>   
>  Pour plus d'informations sur l'ajout de ressources aux projets C\+\+\/CLI, consultez [Ressources dans les applications](../Topic/Resources%20in%20Desktop%20Apps.md) dans le *Guide du développeur .NET Framework.*  
...
## Dans cette section  
 [Fichiers de ressources](../mfc/resource-files-visual-studio.md)  
 ...
 [Symboles : identificateurs de ressources](../mfc/symbols-resource-identifiers.md)  
...
## Rubriques connexes  
 ...
 [Présentation de Visual Studio](http://msdn.microsoft.com/fr-fr/99997089-56ff-4d60-81a9-447062dc98ac)  
