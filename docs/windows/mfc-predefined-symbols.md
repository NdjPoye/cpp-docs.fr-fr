...
Les projets MFC peuvent inclure plusieurs fichiers d'en\-tête qui prennent en charge les fenêtres.  Ils sont ajoutés via des instructions \#include dans le fichier StdAfx.h :  
...
```  
 ...
 Les fichiers d'en\-tête contiennent des valeurs d'ID de symboles pour les valeurs MFC courantes.  Ces symboles sont uniquement disponibles si vous travaillez sur un projet MFC.  Le préfixe AFX\_ est suivi par les préfixes des noms de symboles standard.  
