...
### Pour déplacer ou copier des menus ou des commandes de menu par glisser\-déplacer  
...
### Pour déplacer ou copier des menus ou des commandes de menu à l'aide des commandes de menu contextuel  
...
3.  Si vous déplacez les éléments vers une autre ressource de menu ou un autre fichier de script de ressources, vous devez l'[ouvrir dans une autre fenêtre](../Topic/Customizing%20window%20layouts%20in%20Visual%20Studio.md).  
