...
### Pour changer les propriétés d'un bouton de barre d'outils  
  
1.  Sélectionnez le bouton de barre d'outils.  
  
2.  Tapez le nouvel ID dans la propriété **ID** de la [fenêtre Propriétés](../Topic/Properties%20Window.md) ou utilisez la liste déroulante pour sélectionner un nouvel **ID**.  
