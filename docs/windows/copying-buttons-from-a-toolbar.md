...
### Pour copier des boutons d'une barre d'outils  
  
1.  Maintenez la touche **CTRL** enfoncée.  
  
2.  Dans le volet **Éditeur de barres d'outils**, faites glisser le bouton vers un nouvel emplacement sur la barre d'outils ou vers un nouvel emplacement sur une autre barre d'outils.  
