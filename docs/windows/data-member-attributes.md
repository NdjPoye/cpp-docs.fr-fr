...
Les attributs suivants s'appliquent aux données membres d'une classe, une coclasse, ou une interface.  
  
|Attribut|Description|  
|--------------|-----------------|  
|[db\_accessor](../windows/db-accessor.md)|attributs de **db\_column** de groupes qui participent à la liaison basée sur d' `IAccessor`.|  
...
|[readonly](../windows/readonly-cpp.md)|Interdit l'assignation à une donnée membre.|  
