---
title: "Modification d&#39;une table d&#39;acc&#233;l&#233;rateurs | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "tables d’accélérateurs (C++), modification"
  - "raccourcis clavier (C++), dans une table d’accélérateurs"
...
---
# Modification d&#39;une table d&#39;acc&#233;l&#233;rateurs
...
3.  Sélectionnez un élément dans la zone de liste déroulante fixe, ou tapez sur place pour apporter des modifications.  
    ...
    -   Pour [ID](Id%20Property.xml), sélectionnez dans la liste ou d’un type à modifier.  
