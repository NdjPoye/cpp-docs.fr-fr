...
Les symboles de ce tableau ne s'affichent que dans un projet MFC lorsque la prise en charge d'une base de données a été ajoutée.  Ils prennent en charge la connexion MFC aux serveurs SQL et la programmation de base de données.  
...
|AFX\_IDP\_SQL\_FIELD\_NOT\_FOUND|AFX\_IDP\_SQL\_FILED\_SCHEMA\_ INCOMPATIBILITÉ|  
...
|AFX\_IDP\_SQL\_NO\_POSITIONED\_ MISES À JOUR|AFX\_IDP\_SQL\_NO\_ROWS\_AFFECTED|  
