...
## <a name="remarks"></a>Notes  
 La fonction `_heapmin` réduit le tas en libérant la mémoire de tas inutilisée au profit du système d’exploitation. Si le système d’exploitation ne prend pas en charge `_heapmin` (par exemple Windows 98), la fonction retourne –1 et définit `errno` sur `ENOSYS`.  
