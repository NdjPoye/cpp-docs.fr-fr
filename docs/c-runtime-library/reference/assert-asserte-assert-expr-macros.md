...
## Notes  
 ...
 Sauf indication contraire avec les fonctions [\_CrtSetReportMode](../../c-runtime-library/reference/crtsetreportmode.md) et [\_CrtSetReportFile](../../c-runtime-library/reference/crtsetreportfile.md), les messages s’affichent dans un boîte de dialogue contextuelle, ce qui équivaut à définir :  
  
```c  
_CrtSetReportMode(CRT_ASSERT, _CRTDBG_MODE_WNDW);  
```  
  
 `_CRT_ASSERT` génère le rapport de débogage et détermine sa ou ses destinations, en fonction des modes de rapport actifs et du fichier de rapport défini pour le type de rapport `_CrtDbgReportW`. Par défaut, les erreurs et les échecs d’assertion sont dirigés vers une fenêtre de message de débogage. Les fonctions [\_CrtSetReportMode](../../c-runtime-library/reference/crtsetreportmode.md) et [\_CrtSetReportFile](../../c-runtime-library/reference/crtsetreportfile.md) servent à définir les destinations de chaque type de rapport.  
...
```Output  
Utilisez les macros assert pour évaluer l’expression p1 == p2. crt_ASSERT_macro.c(54) : Will _ASSERT find ’I am p1’ == ’I am p2’ ? crt_ASSERT_macro.c(55) : échouée de l’Assertion ! crt_ASSERT_macro.c(58) : _ASSERTE trouve « Je suis p1 » == 'Me p2' ? crt_ASSERT_macro.c(59) : Assertion failed: p1 == p2 ’I am p1’ != ’I am p2’  
```  
