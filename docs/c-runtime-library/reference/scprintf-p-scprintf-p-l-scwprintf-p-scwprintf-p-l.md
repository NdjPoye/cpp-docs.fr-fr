...
## <a name="remarks"></a>Notes  
 Chaque `argument` éventuel est converti selon la spécification de format correspondante de `format`. Le format se compose de caractères ordinaires et a la même forme et la même fonction que l’argument `format` pour [printf](../../c-runtime-library/reference/printf-printf-l-wprintf-wprintf-l.md).  
