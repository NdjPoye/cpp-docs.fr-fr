...
## <a name="return-value"></a>Valeur de retour  
 ...
 Le comportement de `iscntrl` et `_iscntrl_l` n’est pas défini si `c` n’est pas EOF ou n’appartient pas à la plage 0 à 0xFF, inclus. Quand une bibliothèque CRT de débogage est utilisée et que `c` ne fait pas partie de ces valeurs, les fonctions déclenchent une assertion.  
