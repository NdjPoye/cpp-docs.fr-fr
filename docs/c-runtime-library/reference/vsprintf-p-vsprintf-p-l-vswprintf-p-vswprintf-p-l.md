...
## <a name="return-value"></a>Valeur de retour  
 `_vsprintf_p` et `_vswprintf_p` retournent le nombre de caractères écrits, sans le caractère Null de fin, ou une valeur négative si une erreur de sortie se produit.  
