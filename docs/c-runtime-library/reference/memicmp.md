...
Cette fonction POSIX est déconseillée. Utilisez plutôt [_memicmp](../../c-runtime-library/reference/memicmp-memicmp-l.md), qui est conforme à la spécification ISO C++.