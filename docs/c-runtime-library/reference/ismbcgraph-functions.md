...
## <a name="return-value"></a>Valeur de retour  
 ...
 Les versions de ces fonctions sont identiques, à ceci près que celles qui sont dotées du suffixe `_l` utilisent les paramètres régionaux qui sont passés pour leur comportement dépendant des paramètres régionaux, au lieu des paramètres régionaux actuels. Pour plus d’informations, consultez [Locale](../../c-runtime-library/locale.md).  
