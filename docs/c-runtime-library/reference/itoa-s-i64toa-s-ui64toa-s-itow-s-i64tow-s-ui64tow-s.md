...
|-----------|------------|----------------------|-----------|------------|  
|tous|`NULL`|tous|tous|`EINVAL`|  
|tous|tous|<=0|tous|`EINVAL`|  
|tous|tous|<= longueur de la chaîne de résultat requise|tous|`EINVAL`|  
|tous|tous|tous|`radix` < 2 ou `radix` > 36|`EINVAL`|  
