...
## Notes  
 C\+\+ autorisant la surcharge, vous pouvez appeler des surcharges de `casinh` qui acceptent et retournent des valeurs `_Fcomplex` et `_Lcomplex`. Dans un programme C, `casinh` accepte et retourne toujours un `_Dcomplex` valeur.  
