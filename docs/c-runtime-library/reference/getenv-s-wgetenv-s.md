...
|--------------------|--------------|------------------------|---------------|----------------------|  
|`NULL`|tous|any|tous|`EINVAL`|  
|tous|`NULL`|\>0|tous|`EINVAL`|  
|tous|any|tous|`NULL`|`EINVAL`|  
