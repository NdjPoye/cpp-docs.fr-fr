...
Cette fonction POSIX est déconseillée.  Utilisez plutôt [\_spawnve](../../c-runtime-library/reference/spawnve-wspawnve.md), qui est conforme à la spécification ISO C\+\+.  
