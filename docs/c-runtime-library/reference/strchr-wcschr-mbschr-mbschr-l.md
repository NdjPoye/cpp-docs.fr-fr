...
## <a name="remarks"></a>Notes  
 La fonction `strchr` recherche la première occurrence de `c` dans `str` ou retourne la valeur `NULL` si `c` est introuvable. Le caractère Null de fin est inclus dans la recherche.  
