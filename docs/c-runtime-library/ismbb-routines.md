...
Teste la valeur d’entier donnée `c` pour une condition particulière, en utilisant les paramètres régionaux actuels ou une catégorie d’état de conversion LC\_CTYPE spécifiée.  
...
|[\_ismbbalpha, \_ismbbalpha\_l](http://msdn.microsoft.com/fr-fr/8e54cb92-fc2b-41f5-8ab4-b22ac8aa9ad0)|[\_ismbbkpunct, \_ismbbkpunct\_l](../c-runtime-library/reference/ismbbkpunct-ismbbkpunct-l.md)|  
...
|[\_ismbbalpha](http://msdn.microsoft.com/fr-fr/8e54cb92-fc2b-41f5-8ab4-b22ac8aa9ad0)|`isalpha` &#124;&#124; `_ismbbkalnum`.|  
