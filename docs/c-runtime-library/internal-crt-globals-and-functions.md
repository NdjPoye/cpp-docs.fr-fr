...
manager: "ghogen"
---
# Fonctions et variables globales CRT internes
...
## Macros de valeurs et variables globales CRT internes  
...
## Macros de fonctions et fonctions CRT internes  
 Ces macros de fonctions et fonctions permettent d’implémenter la bibliothèque CRT et la bibliothèque standard C\+\+ \(STL\).  
