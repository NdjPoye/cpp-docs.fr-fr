...
-   Créez un projet vide (sous la **général** onglet), en ajoutant manuellement les fichiers de code source en cliquant sur le nœud de projet dans l’Explorateur de solutions et en choisissant **ajouter &#124; élément existant**.  
