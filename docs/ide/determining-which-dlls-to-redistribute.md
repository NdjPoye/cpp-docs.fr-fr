...
|msvcp*version*.dll|Bibliothèque Standard C++ pour le code natif.|Les applications qui utilisent la [bibliothèque Standard C++](../standard-library/cpp-standard-library-reference.md).|
