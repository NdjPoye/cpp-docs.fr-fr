---
title: Triviale, disposition standard et types POD | Documents Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="trivial-standard-layout-and-pod-types"></a>Triviale, disposition standard et types POD
