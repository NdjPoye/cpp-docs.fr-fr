...
## Notes  
 ...
 L'opérateur `reinterpret_cast` ne peut pas caster les attributs **const**, `volatile` ou **\_\_unaligned**.  Pour plus d'informations sur la suppression de ces attributs, consultez [Opérateur const\_cast](../cpp/const-cast-operator.md).  
