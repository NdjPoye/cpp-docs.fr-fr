...
Représente un vecteur de quatre nombres normaux non signés court.  
...
|Nom|Description|  
|----------|-----------------|  
|[unorm_4 constructeur](#ctor)|Surchargé. Par défaut constructeur initialise tous les éléments à 0.|  
