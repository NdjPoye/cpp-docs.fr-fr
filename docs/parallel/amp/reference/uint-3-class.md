...
|Nom|Description|  
|---------|-----------------|  
|[uint\_3::uint\_3, constructeur](../Topic/uint_3::uint_3%20Constructor.md)|Surchargé.  Le constructeur par défaut, initialise tous les éléments avec la valeur 0.|  
  
### Méthodes publiques  
  
|Nom|Description|  
|---------|-----------------|  
|Méthode uint\_3::get\_x||  
|Méthode uint\_3::get\_xy||  
|Méthode uint\_3::get\_xyz||  
|Méthode uint\_3::get\_xz||  
|Méthode uint\_3::get\_xzy||  
|Méthode uint\_3::get\_y||  
|Méthode uint\_3::get\_yx||  
|Méthode uint\_3::get\_yxz||  
|Méthode uint\_3::get\_yz||  
|Méthode uint\_3::get\_yzx||  
|Méthode uint\_3::get\_z||  
|Méthode uint\_3::get\_zx||  
|Méthode uint\_3::get\_zxy||  
|Méthode uint\_3::get\_zy||  
|Méthode uint\_3::get\_zyx||  
|méthode d'uint\_t::ref\_b||  
|méthode d'uint\_t::ref\_g||  
|méthode d'uint\_t::ref\_r||  
|méthode d'uint\_t::ref\_x||  
|méthode d'uint\_t::ref\_y||  
|méthode d'uint\_t::ref\_z||  
|Méthode uint\_3::set\_x||  
|Méthode uint\_3::set\_xy||  
|Méthode uint\_3::set\_xyz||  
|Méthode uint\_3::set\_xz||  
|Méthode uint\_3::set\_xzy||  
|Méthode uint\_3::set\_y||  
|Méthode uint\_3::set\_yx||  
|Méthode uint\_3::set\_yxz||  
|Méthode uint\_3::set\_yz||  
|Méthode uint\_3::set\_yzx||  
|Méthode uint\_3::set\_z||  
|Méthode uint\_3::set\_zx||  
|Méthode uint\_3::set\_zxy||  
|Méthode uint\_3::set\_zy||  
|Méthode uint\_3::set\_zyx||  
  
### Opérateurs publics  
  
|Nom|Description|  
|---------|-----------------|  
|Opérateur uint\_3::operator\-\-||  
|Opérateur uint\_3::operator%\=||  
|Opérateur uint\_3::operator&\=||  
|Opérateur uint\_3::operator\*\=||  
|Opérateur uint\_3::operator\/\=||  
...
|Nom|Description|  
|---------|-----------------|  
|[uint\_3::size, constante](../Topic/uint_3::size%20Constant.md)||  
  
### Données membres publiques  
  
|Nom|Description|  
|---------|-----------------|  
|Membre de données uint\_3::b||  
|Membre de données uint\_3::bg||  
|Membre de données uint\_3::bgr||  
|Membre de données uint\_3::br||  
|Membre de données uint\_3::brg||  
|Membre de données uint\_3::g||  
|Membre de données uint\_3::gb||  
|Membre de données uint\_3::gbr||  
|Membre de données uint\_3::gr||  
|Membre de données uint\_3::grb||  
|Membre de données uint\_3::r||  
|Membre de données uint\_3::rb||  
|Membre de données uint\_3::rbg||  
|Membre de données uint\_3::rg||  
|Membre de données uint\_3::rgb||  
|Membre de données uint\_3::x||  
|Membre de données uint\_3::xy||  
|Membre de données uint\_3::xyz||  
|Membre de données uint\_3::xz||  
|Membre de données uint\_3::xzy||  
|Membre de données uint\_3::y||  
|Membre de données uint\_3::yx||  
|Membre de données uint\_3::yxz||  
|Membre de données uint\_3::yz||  
|Membre de données uint\_3::yzx||  
|Membre de données uint\_3::z||  
|Membre de données uint\_3::zx||  
|Membre de données uint\_3::zxy||  
|Membre de données uint\_3::zy||  
|Membre de données uint\_3::zyx||  
