...
|Nom|Description|  
|----------|-----------------|  
|[accepter](#accept)|En cas de substitution dans une classe dérivée, accepte un message qui a été offert par ce `ISource` bloc, en transférant la propriété à l’appelant.|  
