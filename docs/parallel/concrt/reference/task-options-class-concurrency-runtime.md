...
##  <a name="get_cancellation_token">task_options::get_cancellation_token, méthode (Runtime d’accès concurrentiel)</a>  
...
##  <a name="get_continuation_context">task_options::get_continuation_context, méthode (Runtime d’accès concurrentiel)</a>  
...
##  <a name="get_scheduler">task_options::get_scheduler, méthode (Runtime d’accès concurrentiel)</a>  
...
##  <a name="has_cancellation_token">task_options::has_cancellation_token, méthode (Runtime d’accès concurrentiel)</a>  
...
##  <a name="has_scheduler">task_options::has_scheduler, méthode (Runtime d’accès concurrentiel)</a>  
...
##  <a name="set_cancellation_token">task_options::set_cancellation_token, méthode (Runtime d’accès concurrentiel)</a>  
...
##  <a name="set_continuation_context">task_options::set_continuation_context, méthode (Runtime d’accès concurrentiel)</a>  
...
##  <a name="ctor">task_options::task_options, constructeur (Runtime d’accès concurrentiel)</a>  
