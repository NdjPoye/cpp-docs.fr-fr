...
#### Paramètres  
 ...
 `_Allocator_type`  
 Type qui représente l'objet d'allocation stocké qui contient des détails sur l'allocation et la désallocation de mémoire pour le vecteur simultané.  Cet argument est facultatif et la valeur par défaut est `std::allocator<``_Key_type``>`.  
...
|Nom|Description|  
|---------|-----------------|  
|[concurrent\_unordered\_multiset::concurrent\_unordered\_multiset, constructeur](../Topic/concurrent_unordered_multiset::concurrent_unordered_multiset%20Constructor.md)|Surchargé.  Construit un multiset non classée simultanée.|  
  
### Méthodes publiques  
  
|Nom|Description|  
|---------|-----------------|  
|[concurrent\_unordered\_multiset::hash\_function, méthode](../Topic/concurrent_unordered_multiset::hash_function%20Method.md)|Retourne l'objet de fonction de hachage stocké.|  
|[concurrent\_unordered\_multiset::insert, méthode](../Topic/concurrent_unordered_multiset::insert%20Method.md)|Surchargé.  Ajoute des éléments à l'objet `concurrent_unordered_multiset`.|  
|[concurrent\_unordered\_multiset::key\_eq, méthode](../Topic/concurrent_unordered_multiset::key_eq%20Method.md)|L'objet de fonction de comparaison d'égalité stocké.|  
|[concurrent\_unordered\_multiset::swap, méthode](../Topic/concurrent_unordered_multiset::swap%20Method.md)|Échange le contenu de deux objets `concurrent_unordered_multiset`.  Cette méthode n'est pas sécurisée du point de vue de l'accès concurrentiel.|  
|[concurrent\_unordered\_multiset::unsafe\_erase, méthode](../Topic/concurrent_unordered_multiset::unsafe_erase%20Method.md)|Surchargé.  Supprime les éléments de `concurrent_unordered_multiset` aux positions spécifiées.  Cette méthode n'est pas sécurisée du point de vue de l'accès concurrentiel.|  
  
### Opérateurs publics  
  
|Nom|Description|  
|---------|-----------------|  
|[concurrent\_unordered\_multiset::operator\=, opérateur](../Topic/concurrent_unordered_multiset::operator=%20Operator.md)|Surchargé.  Assigne le contenu d'un autre objet `concurrent_unordered_multiset` à celui\-ci.  Cette méthode n'est pas sécurisée du point de vue de l'accès concurrentiel.|  
